(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function e(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=e(s);fetch(s.href,r)}})();const Lh="14.9.17",uu=(i,t,e)=>({endTime:t,insertTime:e,type:"exponentialRampToValue",value:i}),hu=(i,t,e)=>({endTime:t,insertTime:e,type:"linearRampToValue",value:i}),Tc=(i,t)=>({startTime:t,type:"setValue",value:i}),Oh=(i,t,e)=>({duration:e,startTime:t,type:"setValueCurve",values:i}),Uh=(i,t,{startTime:e,target:n,timeConstant:s})=>n+(t-n)*Math.exp((e-i)/s),Cs=i=>i.type==="exponentialRampToValue",Uo=i=>i.type==="linearRampToValue",fi=i=>Cs(i)||Uo(i),pl=i=>i.type==="setValue",jn=i=>i.type==="setValueCurve",Fo=(i,t,e,n)=>{const s=i[t];return s===void 0?n:fi(s)||pl(s)?s.value:jn(s)?s.values[s.values.length-1]:Uh(e,Fo(i,t-1,s.startTime,n),s)},du=(i,t,e,n,s)=>e===void 0?[n.insertTime,s]:fi(e)?[e.endTime,e.value]:pl(e)?[e.startTime,e.value]:jn(e)?[e.startTime+e.duration,e.values[e.values.length-1]]:[e.startTime,Fo(i,t-1,e.startTime,s)],Ec=i=>i.type==="cancelAndHold",bc=i=>i.type==="cancelScheduledValues",oi=i=>Ec(i)||bc(i)?i.cancelTime:Cs(i)||Uo(i)?i.endTime:i.startTime,fu=(i,t,e,{endTime:n,value:s})=>e===s?s:0<e&&0<s||e<0&&s<0?e*(s/e)**((i-t)/(n-t)):0,pu=(i,t,e,{endTime:n,value:s})=>e+(i-t)/(n-t)*(s-e),zf=(i,t)=>{const e=Math.floor(t),n=Math.ceil(t);return e===n?i[e]:(1-(t-e))*i[e]+(1-(n-t))*i[n]},Gf=(i,{duration:t,startTime:e,values:n})=>{const s=(i-e)/t*(n.length-1);return zf(n,s)},$r=i=>i.type==="setTarget";class Hf{constructor(t){this._automationEvents=[],this._currenTime=0,this._defaultValue=t}[Symbol.iterator](){return this._automationEvents[Symbol.iterator]()}add(t){const e=oi(t);if(Ec(t)||bc(t)){const n=this._automationEvents.findIndex(r=>bc(t)&&jn(r)?r.startTime+r.duration>=e:oi(r)>=e),s=this._automationEvents[n];if(n!==-1&&(this._automationEvents=this._automationEvents.slice(0,n)),Ec(t)){const r=this._automationEvents[this._automationEvents.length-1];if(s!==void 0&&fi(s)){if(r!==void 0&&$r(r))throw new Error("The internal list is malformed.");const o=r===void 0?s.insertTime:jn(r)?r.startTime+r.duration:oi(r),a=r===void 0?this._defaultValue:jn(r)?r.values[r.values.length-1]:r.value,c=Cs(s)?fu(e,o,a,s):pu(e,o,a,s),l=Cs(s)?uu(c,e,this._currenTime):hu(c,e,this._currenTime);this._automationEvents.push(l)}if(r!==void 0&&$r(r)&&this._automationEvents.push(Tc(this.getValue(e),e)),r!==void 0&&jn(r)&&r.startTime+r.duration>e){const o=e-r.startTime,a=(r.values.length-1)/r.duration,c=Math.max(2,1+Math.ceil(o*a)),l=o/(c-1)*a,u=r.values.slice(0,c);if(l<1)for(let h=1;h<c;h+=1){const d=l*h%1;u[h]=r.values[h-1]*(1-d)+r.values[h]*d}this._automationEvents[this._automationEvents.length-1]=Oh(u,r.startTime,o)}}}else{const n=this._automationEvents.findIndex(o=>oi(o)>e),s=n===-1?this._automationEvents[this._automationEvents.length-1]:this._automationEvents[n-1];if(s!==void 0&&jn(s)&&oi(s)+s.duration>e)return!1;const r=Cs(t)?uu(t.value,t.endTime,this._currenTime):Uo(t)?hu(t.value,e,this._currenTime):t;if(n===-1)this._automationEvents.push(r);else{if(jn(t)&&e+t.duration>oi(this._automationEvents[n]))return!1;this._automationEvents.splice(n,0,r)}}return!0}flush(t){const e=this._automationEvents.findIndex(n=>oi(n)>t);if(e>1){const n=this._automationEvents.slice(e-1),s=n[0];$r(s)&&n.unshift(Tc(Fo(this._automationEvents,e-2,s.startTime,this._defaultValue),s.startTime)),this._automationEvents=n}}getValue(t){if(this._automationEvents.length===0)return this._defaultValue;const e=this._automationEvents.findIndex(o=>oi(o)>t),n=this._automationEvents[e],s=(e===-1?this._automationEvents.length:e)-1,r=this._automationEvents[s];if(r!==void 0&&$r(r)&&(n===void 0||!fi(n)||n.insertTime>t))return Uh(t,Fo(this._automationEvents,s-1,r.startTime,this._defaultValue),r);if(r!==void 0&&pl(r)&&(n===void 0||!fi(n)))return r.value;if(r!==void 0&&jn(r)&&(n===void 0||!fi(n)||r.startTime+r.duration>t))return t<r.startTime+r.duration?Gf(t,r):r.values[r.values.length-1];if(r!==void 0&&fi(r)&&(n===void 0||!fi(n)))return r.value;if(n!==void 0&&Cs(n)){const[o,a]=du(this._automationEvents,s,r,n,this._defaultValue);return fu(t,o,a,n)}if(n!==void 0&&Uo(n)){const[o,a]=du(this._automationEvents,s,r,n,this._defaultValue);return pu(t,o,a,n)}return this._defaultValue}}const Wf=i=>({cancelTime:i,type:"cancelAndHold"}),qf=i=>({cancelTime:i,type:"cancelScheduledValues"}),Xf=(i,t)=>({endTime:t,type:"exponentialRampToValue",value:i}),Yf=(i,t)=>({endTime:t,type:"linearRampToValue",value:i}),jf=(i,t,e)=>({startTime:t,target:i,timeConstant:e,type:"setTarget"}),$f=()=>new DOMException("","AbortError"),Zf=i=>(t,e,[n,s,r],o)=>{i(t[s],[e,n,r],a=>a[0]===e&&a[1]===n,o)},Kf=i=>(t,e,n)=>{const s=[];for(let r=0;r<n.numberOfInputs;r+=1)s.push(new Set);i.set(t,{activeInputs:s,outputs:new Set,passiveInputs:new WeakMap,renderer:e})},Jf=i=>(t,e)=>{i.set(t,{activeInputs:new Set,passiveInputs:new WeakMap,renderer:e})},Ls=new WeakSet,Fh=new WeakMap,ml=new WeakMap,kh=new WeakMap,_l=new WeakMap,Sa=new WeakMap,Bh=new WeakMap,wc=new WeakMap,Ac=new WeakMap,Cc=new WeakMap,Vh={construct(){return Vh}},Qf=i=>{try{const t=new Proxy(i,Vh);new t}catch{return!1}return!0},mu=/^import(?:(?:[\s]+[\w]+|(?:[\s]+[\w]+[\s]*,)?[\s]*\{[\s]*[\w]+(?:[\s]+as[\s]+[\w]+)?(?:[\s]*,[\s]*[\w]+(?:[\s]+as[\s]+[\w]+)?)*[\s]*}|(?:[\s]+[\w]+[\s]*,)?[\s]*\*[\s]+as[\s]+[\w]+)[\s]+from)?(?:[\s]*)("([^"\\]|\\.)+"|'([^'\\]|\\.)+')(?:[\s]*);?/,_u=(i,t)=>{const e=[];let n=i.replace(/^[\s]+/,""),s=n.match(mu);for(;s!==null;){const r=s[1].slice(1,-1),o=s[0].replace(/([\s]+)?;?$/,"").replace(r,new URL(r,t).toString());e.push(o),n=n.slice(s[0].length).replace(/^[\s]+/,""),s=n.match(mu)}return[e.join(";"),n]},gu=i=>{if(i!==void 0&&!Array.isArray(i))throw new TypeError("The parameterDescriptors property of given value for processorCtor is not an array.")},vu=i=>{if(!Qf(i))throw new TypeError("The given value for processorCtor should be a constructor.");if(i.prototype===null||typeof i.prototype!="object")throw new TypeError("The given value for processorCtor should have a prototype.")},tp=(i,t,e,n,s,r,o,a,c,l,u,h,d)=>{let m=0;return(_,g,p={credentials:"omit"})=>{const f=u.get(_);if(f!==void 0&&f.has(g))return Promise.resolve();const y=l.get(_);if(y!==void 0){const w=y.get(g);if(w!==void 0)return w}const x=r(_),T=x.audioWorklet===void 0?s(g).then(([w,E])=>{const[b,C]=_u(w,E),S=`${b};((a,b)=>{(a[b]=a[b]||[]).push((AudioWorkletProcessor,global,registerProcessor,sampleRate,self,window)=>{${C}
})})(window,'_AWGS')`;return e(S)}).then(()=>{const w=d._AWGS.pop();if(w===void 0)throw new SyntaxError;n(x.currentTime,x.sampleRate,()=>w(class{},void 0,(E,b)=>{if(E.trim()==="")throw t();const C=Ac.get(x);if(C!==void 0){if(C.has(E))throw t();vu(b),gu(b.parameterDescriptors),C.set(E,b)}else vu(b),gu(b.parameterDescriptors),Ac.set(x,new Map([[E,b]]))},x.sampleRate,void 0,void 0))}):Promise.all([s(g),Promise.resolve(i(h,h))]).then(([[w,E],b])=>{const C=m+1;m=C;const[S,v]=_u(w,E),F=`${S};((AudioWorkletProcessor,registerProcessor)=>{${v}
})(${b?"AudioWorkletProcessor":"class extends AudioWorkletProcessor {__b=new WeakSet();constructor(){super();(p=>p.postMessage=(q=>(m,t)=>q.call(p,m,t?t.filter(u=>!this.__b.has(u)):t))(p.postMessage))(this.port)}}"},(n,p)=>registerProcessor(n,class extends p{${b?"":"__c = (a) => a.forEach(e=>this.__b.add(e.buffer));"}process(i,o,p){${b?"":"i.forEach(this.__c);o.forEach(this.__c);this.__c(Object.values(p));"}return super.process(i.map(j=>j.some(k=>k.length===0)?[]:j),o,p)}}));registerProcessor('__sac${C}',class extends AudioWorkletProcessor{process(){return !1}})`,z=new Blob([F],{type:"application/javascript; charset=utf-8"}),U=URL.createObjectURL(z);return x.audioWorklet.addModule(U,p).then(()=>{if(a(x))return x;const B=o(x);return B.audioWorklet.addModule(U,p).then(()=>B)}).then(B=>{if(c===null)throw new SyntaxError;try{new c(B,`__sac${C}`)}catch{throw new SyntaxError}}).finally(()=>URL.revokeObjectURL(U))});return y===void 0?l.set(_,new Map([[g,T]])):y.set(g,T),T.then(()=>{const w=u.get(_);w===void 0?u.set(_,new Set([g])):w.add(g)}).finally(()=>{const w=l.get(_);w!==void 0&&w.delete(g)}),T}},xn=(i,t)=>{const e=i.get(t);if(e===void 0)throw new Error("A value with the given key could not be found.");return e},Ma=(i,t)=>{const e=Array.from(i).filter(t);if(e.length>1)throw Error("More than one element was found.");if(e.length===0)throw Error("No element was found.");const[n]=e;return i.delete(n),n},zh=(i,t,e,n)=>{const s=xn(i,t),r=Ma(s,o=>o[0]===e&&o[1]===n);return s.size===0&&i.delete(t),r},Ir=i=>xn(Bh,i),Os=i=>{if(Ls.has(i))throw new Error("The AudioNode is already stored.");Ls.add(i),Ir(i).forEach(t=>t(!0))},Gh=i=>"port"in i,Nr=i=>{if(!Ls.has(i))throw new Error("The AudioNode is not stored.");Ls.delete(i),Ir(i).forEach(t=>t(!1))},Rc=(i,t)=>{!Gh(i)&&t.every(e=>e.size===0)&&Nr(i)},ep=(i,t,e,n,s,r,o,a,c,l,u,h,d)=>{const m=new WeakMap;return(_,g,p,f,y)=>{const{activeInputs:x,passiveInputs:T}=r(g),{outputs:w}=r(_),E=a(_),b=C=>{const S=c(g),v=c(_);if(C){const R=zh(T,_,p,f);i(x,_,R,!1),!y&&!h(_)&&e(v,S,p,f),d(g)&&Os(g)}else{const R=n(x,_,p,f);t(T,f,R,!1),!y&&!h(_)&&s(v,S,p,f);const P=o(g);if(P===0)u(g)&&Rc(g,x);else{const N=m.get(g);N!==void 0&&clearTimeout(N),m.set(g,setTimeout(()=>{u(g)&&Rc(g,x)},P*1e3))}}};return l(w,[g,p,f],C=>C[0]===g&&C[1]===p&&C[2]===f,!0)?(E.add(b),u(_)?i(x,_,[p,f,b],!0):t(T,f,[_,p,b],!0),!0):!1}},np=i=>(t,e,[n,s,r],o)=>{const a=t.get(n);a===void 0?t.set(n,new Set([[s,e,r]])):i(a,[s,e,r],c=>c[0]===s&&c[1]===e,o)},ip=i=>(t,e)=>{const n=i(t,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",gain:0});e.connect(n).connect(t.destination);const s=()=>{e.removeEventListener("ended",s),e.disconnect(n),n.disconnect()};e.addEventListener("ended",s)},sp=i=>(t,e)=>{i(t).add(e)},rp={channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",fftSize:2048,maxDecibels:-30,minDecibels:-100,smoothingTimeConstant:.8},op=(i,t,e,n,s,r)=>class extends i{constructor(a,c){const l=s(a),u={...rp,...c},h=n(l,u),d=r(l)?t():null;super(a,!1,h,d),this._nativeAnalyserNode=h}get fftSize(){return this._nativeAnalyserNode.fftSize}set fftSize(a){this._nativeAnalyserNode.fftSize=a}get frequencyBinCount(){return this._nativeAnalyserNode.frequencyBinCount}get maxDecibels(){return this._nativeAnalyserNode.maxDecibels}set maxDecibels(a){const c=this._nativeAnalyserNode.maxDecibels;if(this._nativeAnalyserNode.maxDecibels=a,!(a>this._nativeAnalyserNode.minDecibels))throw this._nativeAnalyserNode.maxDecibels=c,e()}get minDecibels(){return this._nativeAnalyserNode.minDecibels}set minDecibels(a){const c=this._nativeAnalyserNode.minDecibels;if(this._nativeAnalyserNode.minDecibels=a,!(this._nativeAnalyserNode.maxDecibels>a))throw this._nativeAnalyserNode.minDecibels=c,e()}get smoothingTimeConstant(){return this._nativeAnalyserNode.smoothingTimeConstant}set smoothingTimeConstant(a){this._nativeAnalyserNode.smoothingTimeConstant=a}getByteFrequencyData(a){this._nativeAnalyserNode.getByteFrequencyData(a)}getByteTimeDomainData(a){this._nativeAnalyserNode.getByteTimeDomainData(a)}getFloatFrequencyData(a){this._nativeAnalyserNode.getFloatFrequencyData(a)}getFloatTimeDomainData(a){this._nativeAnalyserNode.getFloatTimeDomainData(a)}},Ue=(i,t)=>i.context===t,ap=(i,t,e)=>()=>{const n=new WeakMap,s=async(r,o)=>{let a=t(r);if(!Ue(a,o)){const l={channelCount:a.channelCount,channelCountMode:a.channelCountMode,channelInterpretation:a.channelInterpretation,fftSize:a.fftSize,maxDecibels:a.maxDecibels,minDecibels:a.minDecibels,smoothingTimeConstant:a.smoothingTimeConstant};a=i(o,l)}return n.set(o,a),await e(r,o,a),a};return{render(r,o){const a=n.get(o);return a!==void 0?Promise.resolve(a):s(r,o)}}},ko=i=>{try{i.copyToChannel(new Float32Array(1),0,-1)}catch{return!1}return!0},Un=()=>new DOMException("","IndexSizeError"),gl=i=>{i.getChannelData=(t=>e=>{try{return t.call(i,e)}catch(n){throw n.code===12?Un():n}})(i.getChannelData)},cp={numberOfChannels:1},lp=(i,t,e,n,s,r,o,a)=>{let c=null;return class Hh{constructor(u){if(s===null)throw new Error("Missing the native OfflineAudioContext constructor.");const{length:h,numberOfChannels:d,sampleRate:m}={...cp,...u};c===null&&(c=new s(1,1,44100));const _=n!==null&&t(r,r)?new n({length:h,numberOfChannels:d,sampleRate:m}):c.createBuffer(d,h,m);if(_.numberOfChannels===0)throw e();return typeof _.copyFromChannel!="function"?(o(_),gl(_)):t(ko,()=>ko(_))||a(_),i.add(_),_}static[Symbol.hasInstance](u){return u!==null&&typeof u=="object"&&Object.getPrototypeOf(u)===Hh.prototype||i.has(u)}}},He=-34028234663852886e22,ke=-He,Jn=i=>Ls.has(i),up={buffer:null,channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",loop:!1,loopEnd:0,loopStart:0,playbackRate:1},hp=(i,t,e,n,s,r,o,a)=>class extends i{constructor(l,u){const h=r(l),d={...up,...u},m=s(h,d),_=o(h),g=_?t():null;super(l,!1,m,g),this._audioBufferSourceNodeRenderer=g,this._isBufferNullified=!1,this._isBufferSet=d.buffer!==null,this._nativeAudioBufferSourceNode=m,this._onended=null,this._playbackRate=e(this,_,m.playbackRate,ke,He)}get buffer(){return this._isBufferNullified?null:this._nativeAudioBufferSourceNode.buffer}set buffer(l){if(this._nativeAudioBufferSourceNode.buffer=l,l!==null){if(this._isBufferSet)throw n();this._isBufferSet=!0}}get loop(){return this._nativeAudioBufferSourceNode.loop}set loop(l){this._nativeAudioBufferSourceNode.loop=l}get loopEnd(){return this._nativeAudioBufferSourceNode.loopEnd}set loopEnd(l){this._nativeAudioBufferSourceNode.loopEnd=l}get loopStart(){return this._nativeAudioBufferSourceNode.loopStart}set loopStart(l){this._nativeAudioBufferSourceNode.loopStart=l}get onended(){return this._onended}set onended(l){const u=typeof l=="function"?a(this,l):null;this._nativeAudioBufferSourceNode.onended=u;const h=this._nativeAudioBufferSourceNode.onended;this._onended=h!==null&&h===u?l:h}get playbackRate(){return this._playbackRate}start(l=0,u=0,h){if(this._nativeAudioBufferSourceNode.start(l,u,h),this._audioBufferSourceNodeRenderer!==null&&(this._audioBufferSourceNodeRenderer.start=h===void 0?[l,u]:[l,u,h]),this.context.state!=="closed"){Os(this);const d=()=>{this._nativeAudioBufferSourceNode.removeEventListener("ended",d),Jn(this)&&Nr(this)};this._nativeAudioBufferSourceNode.addEventListener("ended",d)}}stop(l=0){this._nativeAudioBufferSourceNode.stop(l),this._audioBufferSourceNodeRenderer!==null&&(this._audioBufferSourceNodeRenderer.stop=l)}},dp=(i,t,e,n,s)=>()=>{const r=new WeakMap;let o=null,a=null;const c=async(l,u)=>{let h=e(l);const d=Ue(h,u);if(!d){const m={buffer:h.buffer,channelCount:h.channelCount,channelCountMode:h.channelCountMode,channelInterpretation:h.channelInterpretation,loop:h.loop,loopEnd:h.loopEnd,loopStart:h.loopStart,playbackRate:h.playbackRate.value};h=t(u,m),o!==null&&h.start(...o),a!==null&&h.stop(a)}return r.set(u,h),d?await i(u,l.playbackRate,h.playbackRate):await n(u,l.playbackRate,h.playbackRate),await s(l,u,h),h};return{set start(l){o=l},set stop(l){a=l},render(l,u){const h=r.get(u);return h!==void 0?Promise.resolve(h):c(l,u)}}},fp=i=>"playbackRate"in i,pp=i=>"frequency"in i&&"gain"in i,mp=i=>"offset"in i,_p=i=>!("frequency"in i)&&"gain"in i,gp=i=>"detune"in i&&"frequency"in i&&!("gain"in i),vp=i=>"pan"in i,Be=i=>xn(Fh,i),Lr=i=>xn(kh,i),Dc=(i,t)=>{const{activeInputs:e}=Be(i);e.forEach(s=>s.forEach(([r])=>{t.includes(i)||Dc(r,[...t,i])}));const n=fp(i)?[i.playbackRate]:Gh(i)?Array.from(i.parameters.values()):pp(i)?[i.Q,i.detune,i.frequency,i.gain]:mp(i)?[i.offset]:_p(i)?[i.gain]:gp(i)?[i.detune,i.frequency]:vp(i)?[i.pan]:[];for(const s of n){const r=Lr(s);r!==void 0&&r.activeInputs.forEach(([o])=>Dc(o,t))}Jn(i)&&Nr(i)},Wh=i=>{Dc(i.destination,[])},xp=i=>i===void 0||typeof i=="number"||typeof i=="string"&&(i==="balanced"||i==="interactive"||i==="playback"),yp=(i,t,e,n,s,r,o,a,c)=>class extends i{constructor(u={}){if(c===null)throw new Error("Missing the native AudioContext constructor.");let h;try{h=new c(u)}catch(_){throw _.code===12&&_.message==="sampleRate is not in range"?e():_}if(h===null)throw n();if(!xp(u.latencyHint))throw new TypeError(`The provided value '${u.latencyHint}' is not a valid enum value of type AudioContextLatencyCategory.`);if(u.sampleRate!==void 0&&h.sampleRate!==u.sampleRate)throw e();super(h,2);const{latencyHint:d}=u,{sampleRate:m}=h;if(this._baseLatency=typeof h.baseLatency=="number"?h.baseLatency:d==="balanced"?512/m:d==="interactive"||d===void 0?256/m:d==="playback"?1024/m:Math.max(2,Math.min(128,Math.round(d*m/128)))*128/m,this._nativeAudioContext=h,c.name==="webkitAudioContext"?(this._nativeGainNode=h.createGain(),this._nativeOscillatorNode=h.createOscillator(),this._nativeGainNode.gain.value=1e-37,this._nativeOscillatorNode.connect(this._nativeGainNode).connect(h.destination),this._nativeOscillatorNode.start()):(this._nativeGainNode=null,this._nativeOscillatorNode=null),this._state=null,h.state==="running"){this._state="suspended";const _=()=>{this._state==="suspended"&&(this._state=null),h.removeEventListener("statechange",_)};h.addEventListener("statechange",_)}}get baseLatency(){return this._baseLatency}get state(){return this._state!==null?this._state:this._nativeAudioContext.state}close(){return this.state==="closed"?this._nativeAudioContext.close().then(()=>{throw t()}):(this._state==="suspended"&&(this._state=null),this._nativeAudioContext.close().then(()=>{this._nativeGainNode!==null&&this._nativeOscillatorNode!==null&&(this._nativeOscillatorNode.stop(),this._nativeGainNode.disconnect(),this._nativeOscillatorNode.disconnect()),Wh(this)}))}createMediaElementSource(u){return new s(this,{mediaElement:u})}createMediaStreamDestination(){return new r(this)}createMediaStreamSource(u){return new o(this,{mediaStream:u})}createMediaStreamTrackSource(u){return new a(this,{mediaStreamTrack:u})}resume(){return this._state==="suspended"?new Promise((u,h)=>{const d=()=>{this._nativeAudioContext.removeEventListener("statechange",d),this._nativeAudioContext.state==="running"?u():this.resume().then(u,h)};this._nativeAudioContext.addEventListener("statechange",d)}):this._nativeAudioContext.resume().catch(u=>{throw u===void 0||u.code===15?t():u})}suspend(){return this._nativeAudioContext.suspend().catch(u=>{throw u===void 0?t():u})}},Sp=(i,t,e,n,s,r,o,a)=>class extends i{constructor(l,u){const h=r(l),d=o(h),m=s(h,u,d),_=d?t(a):null;super(l,!1,m,_),this._isNodeOfNativeOfflineAudioContext=d,this._nativeAudioDestinationNode=m}get channelCount(){return this._nativeAudioDestinationNode.channelCount}set channelCount(l){if(this._isNodeOfNativeOfflineAudioContext)throw n();if(l>this._nativeAudioDestinationNode.maxChannelCount)throw e();this._nativeAudioDestinationNode.channelCount=l}get channelCountMode(){return this._nativeAudioDestinationNode.channelCountMode}set channelCountMode(l){if(this._isNodeOfNativeOfflineAudioContext)throw n();this._nativeAudioDestinationNode.channelCountMode=l}get maxChannelCount(){return this._nativeAudioDestinationNode.maxChannelCount}},Mp=i=>{const t=new WeakMap,e=async(n,s)=>{const r=s.destination;return t.set(s,r),await i(n,s,r),r};return{render(n,s){const r=t.get(s);return r!==void 0?Promise.resolve(r):e(n,s)}}},Tp=(i,t,e,n,s,r,o,a)=>(c,l)=>{const u=l.listener,h=()=>{const w=new Float32Array(1),E=t(l,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"speakers",numberOfInputs:9}),b=o(l);let C=!1,S=[0,0,-1,0,1,0],v=[0,0,0];const R=()=>{if(C)return;C=!0;const z=n(l,256,9,0);z.onaudioprocess=({inputBuffer:U})=>{const B=[r(U,w,0),r(U,w,1),r(U,w,2),r(U,w,3),r(U,w,4),r(U,w,5)];B.some((j,J)=>j!==S[J])&&(u.setOrientation(...B),S=B);const V=[r(U,w,6),r(U,w,7),r(U,w,8)];V.some((j,J)=>j!==v[J])&&(u.setPosition(...V),v=V)},E.connect(z)},P=z=>U=>{U!==S[z]&&(S[z]=U,u.setOrientation(...S))},N=z=>U=>{U!==v[z]&&(v[z]=U,u.setPosition(...v))},F=(z,U,B)=>{const V=e(l,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",offset:U});V.connect(E,0,z),V.start(),Object.defineProperty(V.offset,"defaultValue",{get(){return U}});const j=i({context:c},b,V.offset,ke,He);return a(j,"value",J=>()=>J.call(j),J=>nt=>{try{J.call(j,nt)}catch(xt){if(xt.code!==9)throw xt}R(),b&&B(nt)}),j.cancelAndHoldAtTime=(J=>b?()=>{throw s()}:(...nt)=>{const xt=J.apply(j,nt);return R(),xt})(j.cancelAndHoldAtTime),j.cancelScheduledValues=(J=>b?()=>{throw s()}:(...nt)=>{const xt=J.apply(j,nt);return R(),xt})(j.cancelScheduledValues),j.exponentialRampToValueAtTime=(J=>b?()=>{throw s()}:(...nt)=>{const xt=J.apply(j,nt);return R(),xt})(j.exponentialRampToValueAtTime),j.linearRampToValueAtTime=(J=>b?()=>{throw s()}:(...nt)=>{const xt=J.apply(j,nt);return R(),xt})(j.linearRampToValueAtTime),j.setTargetAtTime=(J=>b?()=>{throw s()}:(...nt)=>{const xt=J.apply(j,nt);return R(),xt})(j.setTargetAtTime),j.setValueAtTime=(J=>b?()=>{throw s()}:(...nt)=>{const xt=J.apply(j,nt);return R(),xt})(j.setValueAtTime),j.setValueCurveAtTime=(J=>b?()=>{throw s()}:(...nt)=>{const xt=J.apply(j,nt);return R(),xt})(j.setValueCurveAtTime),j};return{forwardX:F(0,0,P(0)),forwardY:F(1,0,P(1)),forwardZ:F(2,-1,P(2)),positionX:F(6,0,N(0)),positionY:F(7,0,N(1)),positionZ:F(8,0,N(2)),upX:F(3,0,P(3)),upY:F(4,1,P(4)),upZ:F(5,0,P(5))}},{forwardX:d,forwardY:m,forwardZ:_,positionX:g,positionY:p,positionZ:f,upX:y,upY:x,upZ:T}=u.forwardX===void 0?h():u;return{get forwardX(){return d},get forwardY(){return m},get forwardZ(){return _},get positionX(){return g},get positionY(){return p},get positionZ(){return f},get upX(){return y},get upY(){return x},get upZ(){return T}}},Bo=i=>"context"in i,Or=i=>Bo(i[0]),is=(i,t,e,n)=>{for(const s of i)if(e(s)){if(n)return!1;throw Error("The set contains at least one similar element.")}return i.add(t),!0},xu=(i,t,[e,n],s)=>{is(i,[t,e,n],r=>r[0]===t&&r[1]===e,s)},yu=(i,[t,e,n],s)=>{const r=i.get(t);r===void 0?i.set(t,new Set([[e,n]])):is(r,[e,n],o=>o[0]===e,s)},$s=i=>"inputs"in i,Vo=(i,t,e,n)=>{if($s(t)){const s=t.inputs[n];return i.connect(s,e,0),[s,e,0]}return i.connect(t,e,n),[t,e,n]},qh=(i,t,e)=>{for(const n of i)if(n[0]===t&&n[1]===e)return i.delete(n),n;return null},Ep=(i,t,e)=>Ma(i,n=>n[0]===t&&n[1]===e),Xh=(i,t)=>{if(!Ir(i).delete(t))throw new Error("Missing the expected event listener.")},Yh=(i,t,e)=>{const n=xn(i,t),s=Ma(n,r=>r[0]===e);return n.size===0&&i.delete(t),s},zo=(i,t,e,n)=>{$s(t)?i.disconnect(t.inputs[n],e,0):i.disconnect(t,e,n)},ce=i=>xn(ml,i),pr=i=>xn(_l,i),Yi=i=>wc.has(i),Eo=i=>!Ls.has(i),Su=(i,t)=>new Promise(e=>{if(t!==null)e(!0);else{const n=i.createScriptProcessor(256,1,1),s=i.createGain(),r=i.createBuffer(1,2,44100),o=r.getChannelData(0);o[0]=1,o[1]=1;const a=i.createBufferSource();a.buffer=r,a.loop=!0,a.connect(n).connect(i.destination),a.connect(s),a.disconnect(s),n.onaudioprocess=c=>{const l=c.inputBuffer.getChannelData(0);Array.prototype.some.call(l,u=>u===1)?e(!0):e(!1),a.stop(),n.onaudioprocess=null,a.disconnect(n),n.disconnect(i.destination)},a.start()}}),Ya=(i,t)=>{const e=new Map;for(const n of i)for(const s of n){const r=e.get(s);e.set(s,r===void 0?1:r+1)}e.forEach((n,s)=>t(s,n))},Go=i=>"context"in i,bp=i=>{const t=new Map;i.connect=(e=>(n,s=0,r=0)=>{const o=Go(n)?e(n,s,r):e(n,s),a=t.get(n);return a===void 0?t.set(n,[{input:r,output:s}]):a.every(c=>c.input!==r||c.output!==s)&&a.push({input:r,output:s}),o})(i.connect.bind(i)),i.disconnect=(e=>(n,s,r)=>{if(e.apply(i),n===void 0)t.clear();else if(typeof n=="number")for(const[o,a]of t){const c=a.filter(l=>l.output!==n);c.length===0?t.delete(o):t.set(o,c)}else if(t.has(n))if(s===void 0)t.delete(n);else{const o=t.get(n);if(o!==void 0){const a=o.filter(c=>c.output!==s&&(c.input!==r||r===void 0));a.length===0?t.delete(n):t.set(n,a)}}for(const[o,a]of t)a.forEach(c=>{Go(o)?i.connect(o,c.output,c.input):i.connect(o,c.output)})})(i.disconnect)},wp=(i,t,e,n)=>{const{activeInputs:s,passiveInputs:r}=Lr(t),{outputs:o}=Be(i),a=Ir(i),c=l=>{const u=ce(i),h=pr(t);if(l){const d=Yh(r,i,e);xu(s,i,d,!1),!n&&!Yi(i)&&u.connect(h,e)}else{const d=Ep(s,i,e);yu(r,d,!1),!n&&!Yi(i)&&u.disconnect(h,e)}};return is(o,[t,e],l=>l[0]===t&&l[1]===e,!0)?(a.add(c),Jn(i)?xu(s,i,[e,c],!0):yu(r,[i,e,c],!0),!0):!1},Ap=(i,t,e,n)=>{const{activeInputs:s,passiveInputs:r}=Be(t),o=qh(s[n],i,e);return o===null?[zh(r,i,e,n)[2],!1]:[o[2],!0]},Cp=(i,t,e)=>{const{activeInputs:n,passiveInputs:s}=Lr(t),r=qh(n,i,e);return r===null?[Yh(s,i,e)[1],!1]:[r[2],!0]},vl=(i,t,e,n,s)=>{const[r,o]=Ap(i,e,n,s);if(r!==null&&(Xh(i,r),o&&!t&&!Yi(i)&&zo(ce(i),ce(e),n,s)),Jn(e)){const{activeInputs:a}=Be(e);Rc(e,a)}},xl=(i,t,e,n)=>{const[s,r]=Cp(i,e,n);s!==null&&(Xh(i,s),r&&!t&&!Yi(i)&&ce(i).disconnect(pr(e),n))},Rp=(i,t)=>{const e=Be(i),n=[];for(const s of e.outputs)Or(s)?vl(i,t,...s):xl(i,t,...s),n.push(s[0]);return e.outputs.clear(),n},Dp=(i,t,e)=>{const n=Be(i),s=[];for(const r of n.outputs)r[1]===e&&(Or(r)?vl(i,t,...r):xl(i,t,...r),s.push(r[0]),n.outputs.delete(r));return s},Pp=(i,t,e,n,s)=>{const r=Be(i);return Array.from(r.outputs).filter(o=>o[0]===e&&(n===void 0||o[1]===n)&&(s===void 0||o[2]===s)).map(o=>(Or(o)?vl(i,t,...o):xl(i,t,...o),r.outputs.delete(o),o[0]))},Ip=(i,t,e,n,s,r,o,a,c,l,u,h,d,m,_,g)=>class extends l{constructor(f,y,x,T){super(x),this._context=f,this._nativeAudioNode=x;const w=u(f);h(w)&&e(Su,()=>Su(w,g))!==!0&&bp(x),ml.set(this,x),Bh.set(this,new Set),f.state!=="closed"&&y&&Os(this),i(this,T,x)}get channelCount(){return this._nativeAudioNode.channelCount}set channelCount(f){this._nativeAudioNode.channelCount=f}get channelCountMode(){return this._nativeAudioNode.channelCountMode}set channelCountMode(f){this._nativeAudioNode.channelCountMode=f}get channelInterpretation(){return this._nativeAudioNode.channelInterpretation}set channelInterpretation(f){this._nativeAudioNode.channelInterpretation=f}get context(){return this._context}get numberOfInputs(){return this._nativeAudioNode.numberOfInputs}get numberOfOutputs(){return this._nativeAudioNode.numberOfOutputs}connect(f,y=0,x=0){if(y<0||y>=this._nativeAudioNode.numberOfOutputs)throw s();const T=u(this._context),w=_(T);if(d(f)||m(f))throw r();if(Bo(f)){const C=ce(f);try{const v=Vo(this._nativeAudioNode,C,y,x),R=Eo(this);(w||R)&&this._nativeAudioNode.disconnect(...v),this.context.state!=="closed"&&!R&&Eo(f)&&Os(f)}catch(v){throw v.code===12?r():v}if(t(this,f,y,x,w)){const v=c([this],f);Ya(v,n(w))}return f}const E=pr(f);if(E.name==="playbackRate"&&E.maxValue===1024)throw o();try{this._nativeAudioNode.connect(E,y),(w||Eo(this))&&this._nativeAudioNode.disconnect(E,y)}catch(C){throw C.code===12?r():C}if(wp(this,f,y,w)){const C=c([this],f);Ya(C,n(w))}}disconnect(f,y,x){let T;const w=u(this._context),E=_(w);if(f===void 0)T=Rp(this,E);else if(typeof f=="number"){if(f<0||f>=this.numberOfOutputs)throw s();T=Dp(this,E,f)}else{if(y!==void 0&&(y<0||y>=this.numberOfOutputs)||Bo(f)&&x!==void 0&&(x<0||x>=f.numberOfInputs))throw s();if(T=Pp(this,E,f,y,x),T.length===0)throw r()}for(const b of T){const C=c([this],b);Ya(C,a)}}},Np=(i,t,e,n,s,r,o,a,c,l,u,h,d)=>(m,_,g,p=null,f=null)=>{const y=g.value,x=new Hf(y),T=_?n(x):null,w={get defaultValue(){return y},get maxValue(){return p===null?g.maxValue:p},get minValue(){return f===null?g.minValue:f},get value(){return g.value},set value(E){g.value=E,w.setValueAtTime(E,m.context.currentTime)},cancelAndHoldAtTime(E){if(typeof g.cancelAndHoldAtTime=="function")T===null&&x.flush(m.context.currentTime),x.add(s(E)),g.cancelAndHoldAtTime(E);else{const b=Array.from(x).pop();T===null&&x.flush(m.context.currentTime),x.add(s(E));const C=Array.from(x).pop();g.cancelScheduledValues(E),b!==C&&C!==void 0&&(C.type==="exponentialRampToValue"?g.exponentialRampToValueAtTime(C.value,C.endTime):C.type==="linearRampToValue"?g.linearRampToValueAtTime(C.value,C.endTime):C.type==="setValue"?g.setValueAtTime(C.value,C.startTime):C.type==="setValueCurve"&&g.setValueCurveAtTime(C.values,C.startTime,C.duration))}return w},cancelScheduledValues(E){return T===null&&x.flush(m.context.currentTime),x.add(r(E)),g.cancelScheduledValues(E),w},exponentialRampToValueAtTime(E,b){if(E===0)throw new RangeError;if(!Number.isFinite(b)||b<0)throw new RangeError;const C=m.context.currentTime;return T===null&&x.flush(C),Array.from(x).length===0&&(x.add(l(y,C)),g.setValueAtTime(y,C)),x.add(o(E,b)),g.exponentialRampToValueAtTime(E,b),w},linearRampToValueAtTime(E,b){const C=m.context.currentTime;return T===null&&x.flush(C),Array.from(x).length===0&&(x.add(l(y,C)),g.setValueAtTime(y,C)),x.add(a(E,b)),g.linearRampToValueAtTime(E,b),w},setTargetAtTime(E,b,C){return T===null&&x.flush(m.context.currentTime),x.add(c(E,b,C)),g.setTargetAtTime(E,b,C),w},setValueAtTime(E,b){return T===null&&x.flush(m.context.currentTime),x.add(l(E,b)),g.setValueAtTime(E,b),w},setValueCurveAtTime(E,b,C){const S=E instanceof Float32Array?E:new Float32Array(E);if(h!==null&&h.name==="webkitAudioContext"){const v=b+C,R=m.context.sampleRate,P=Math.ceil(b*R),N=Math.floor(v*R),F=N-P,z=new Float32Array(F);for(let B=0;B<F;B+=1){const V=(S.length-1)/C*((P+B)/R-b),j=Math.floor(V),J=Math.ceil(V);z[B]=j===J?S[j]:(1-(V-j))*S[j]+(1-(J-V))*S[J]}T===null&&x.flush(m.context.currentTime),x.add(u(z,b,C)),g.setValueCurveAtTime(z,b,C);const U=N/R;U<v&&d(w,z[z.length-1],U),d(w,S[S.length-1],v)}else T===null&&x.flush(m.context.currentTime),x.add(u(S,b,C)),g.setValueCurveAtTime(S,b,C);return w}};return e.set(w,g),t.set(w,m),i(w,T),w},Lp=i=>({replay(t){for(const e of i)if(e.type==="exponentialRampToValue"){const{endTime:n,value:s}=e;t.exponentialRampToValueAtTime(s,n)}else if(e.type==="linearRampToValue"){const{endTime:n,value:s}=e;t.linearRampToValueAtTime(s,n)}else if(e.type==="setTarget"){const{startTime:n,target:s,timeConstant:r}=e;t.setTargetAtTime(s,n,r)}else if(e.type==="setValue"){const{startTime:n,value:s}=e;t.setValueAtTime(s,n)}else if(e.type==="setValueCurve"){const{duration:n,startTime:s,values:r}=e;t.setValueCurveAtTime(r,s,n)}else throw new Error("Can't apply an unknown automation.")}});class jh{constructor(t){this._map=new Map(t)}get size(){return this._map.size}entries(){return this._map.entries()}forEach(t,e=null){return this._map.forEach((n,s)=>t.call(e,n,s,this))}get(t){return this._map.get(t)}has(t){return this._map.has(t)}keys(){return this._map.keys()}values(){return this._map.values()}}const Op={channelCount:2,channelCountMode:"explicit",channelInterpretation:"speakers",numberOfInputs:1,numberOfOutputs:1,parameterData:{},processorOptions:{}},Up=(i,t,e,n,s,r,o,a,c,l,u,h,d,m)=>class extends t{constructor(g,p,f){var y;const x=a(g),T=c(x),w=u({...Op,...f});d(w);const E=Ac.get(x),b=E==null?void 0:E.get(p),C=T||x.state!=="closed"?x:(y=o(x))!==null&&y!==void 0?y:x,S=s(C,T?null:g.baseLatency,l,p,b,w),v=T?n(p,w,b):null;super(g,!0,S,v);const R=[];S.parameters.forEach((N,F)=>{const z=e(this,T,N);R.push([F,z])}),this._nativeAudioWorkletNode=S,this._onprocessorerror=null,this._parameters=new jh(R),T&&i(x,this);const{activeInputs:P}=r(this);h(S,P)}get onprocessorerror(){return this._onprocessorerror}set onprocessorerror(g){const p=typeof g=="function"?m(this,g):null;this._nativeAudioWorkletNode.onprocessorerror=p;const f=this._nativeAudioWorkletNode.onprocessorerror;this._onprocessorerror=f!==null&&f===p?g:f}get parameters(){return this._parameters===null?this._nativeAudioWorkletNode.parameters:this._parameters}get port(){return this._nativeAudioWorkletNode.port}};function Ho(i,t,e,n,s){if(typeof i.copyFromChannel=="function")t[e].byteLength===0&&(t[e]=new Float32Array(128)),i.copyFromChannel(t[e],n,s);else{const r=i.getChannelData(n);if(t[e].byteLength===0)t[e]=r.slice(s,s+128);else{const o=new Float32Array(r.buffer,s*Float32Array.BYTES_PER_ELEMENT,128);t[e].set(o)}}}const $h=(i,t,e,n,s)=>{typeof i.copyToChannel=="function"?t[e].byteLength!==0&&i.copyToChannel(t[e],n,s):t[e].byteLength!==0&&i.getChannelData(n).set(t[e],s)},Wo=(i,t)=>{const e=[];for(let n=0;n<i;n+=1){const s=[],r=typeof t=="number"?t:t[n];for(let o=0;o<r;o+=1)s.push(new Float32Array(128));e.push(s)}return e},Fp=(i,t)=>{const e=xn(Cc,i),n=ce(t);return xn(e,n)},kp=async(i,t,e,n,s,r,o)=>{const a=t===null?Math.ceil(i.context.length/128)*128:t.length,c=n.channelCount*n.numberOfInputs,l=s.reduce((p,f)=>p+f,0),u=l===0?null:e.createBuffer(l,a,e.sampleRate);if(r===void 0)throw new Error("Missing the processor constructor.");const h=Be(i),d=await Fp(e,i),m=Wo(n.numberOfInputs,n.channelCount),_=Wo(n.numberOfOutputs,s),g=Array.from(i.parameters.keys()).reduce((p,f)=>({...p,[f]:new Float32Array(128)}),{});for(let p=0;p<a;p+=128){if(n.numberOfInputs>0&&t!==null)for(let f=0;f<n.numberOfInputs;f+=1)for(let y=0;y<n.channelCount;y+=1)Ho(t,m[f],y,y,p);r.parameterDescriptors!==void 0&&t!==null&&r.parameterDescriptors.forEach(({name:f},y)=>{Ho(t,g,f,c+y,p)});for(let f=0;f<n.numberOfInputs;f+=1)for(let y=0;y<s[f];y+=1)_[f][y].byteLength===0&&(_[f][y]=new Float32Array(128));try{const f=m.map((x,T)=>h.activeInputs[T].size===0?[]:x),y=o(p/e.sampleRate,e.sampleRate,()=>d.process(f,_,g));if(u!==null)for(let x=0,T=0;x<n.numberOfOutputs;x+=1){for(let w=0;w<s[x];w+=1)$h(u,_[x],w,T+w,p);T+=s[x]}if(!y)break}catch(f){i.dispatchEvent(new ErrorEvent("processorerror",{colno:f.colno,filename:f.filename,lineno:f.lineno,message:f.message}));break}}return u},Bp=(i,t,e,n,s,r,o,a,c,l,u,h,d,m,_,g)=>(p,f,y)=>{const x=new WeakMap;let T=null;const w=async(E,b)=>{let C=u(E),S=null;const v=Ue(C,b),R=Array.isArray(f.outputChannelCount)?f.outputChannelCount:Array.from(f.outputChannelCount);if(h===null){const P=R.reduce((U,B)=>U+B,0),N=s(b,{channelCount:Math.max(1,P),channelCountMode:"explicit",channelInterpretation:"discrete",numberOfOutputs:Math.max(1,P)}),F=[];for(let U=0;U<E.numberOfOutputs;U+=1)F.push(n(b,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"speakers",numberOfInputs:R[U]}));const z=o(b,{channelCount:f.channelCount,channelCountMode:f.channelCountMode,channelInterpretation:f.channelInterpretation,gain:1});z.connect=t.bind(null,F),z.disconnect=c.bind(null,F),S=[N,F,z]}else v||(C=new h(b,p));if(x.set(b,S===null?C:S[2]),S!==null){if(T===null){if(y===void 0)throw new Error("Missing the processor constructor.");if(d===null)throw new Error("Missing the native OfflineAudioContext constructor.");const B=E.channelCount*E.numberOfInputs,V=y.parameterDescriptors===void 0?0:y.parameterDescriptors.length,j=B+V;T=kp(E,j===0?null:await(async()=>{const nt=new d(j,Math.ceil(E.context.length/128)*128,b.sampleRate),xt=[],Ot=[];for(let ot=0;ot<f.numberOfInputs;ot+=1)xt.push(o(nt,{channelCount:f.channelCount,channelCountMode:f.channelCountMode,channelInterpretation:f.channelInterpretation,gain:1})),Ot.push(s(nt,{channelCount:f.channelCount,channelCountMode:"explicit",channelInterpretation:"discrete",numberOfOutputs:f.channelCount}));const X=await Promise.all(Array.from(E.parameters.values()).map(async ot=>{const ut=r(nt,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",offset:ot.value});return await m(nt,ot,ut.offset),ut})),Y=n(nt,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"speakers",numberOfInputs:Math.max(1,B+V)});for(let ot=0;ot<f.numberOfInputs;ot+=1){xt[ot].connect(Ot[ot]);for(let ut=0;ut<f.channelCount;ut+=1)Ot[ot].connect(Y,ut,ot*f.channelCount+ut)}for(const[ot,ut]of X.entries())ut.connect(Y,0,B+ot),ut.start(0);return Y.connect(nt.destination),await Promise.all(xt.map(ot=>_(E,nt,ot))),g(nt)})(),b,f,R,y,l)}const P=await T,N=e(b,{buffer:null,channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",loop:!1,loopEnd:0,loopStart:0,playbackRate:1}),[F,z,U]=S;P!==null&&(N.buffer=P,N.start(0)),N.connect(F);for(let B=0,V=0;B<E.numberOfOutputs;B+=1){const j=z[B];for(let J=0;J<R[B];J+=1)F.connect(j,V+J,J);V+=R[B]}return U}if(v)for(const[P,N]of E.parameters.entries())await i(b,N,C.parameters.get(P));else for(const[P,N]of E.parameters.entries())await m(b,N,C.parameters.get(P));return await _(E,b,C),C};return{render(E,b){a(b,E);const C=x.get(b);return C!==void 0?Promise.resolve(C):w(E,b)}}},Vp=(i,t,e,n,s,r,o,a,c,l,u,h,d,m,_,g,p,f,y,x)=>class extends _{constructor(w,E){super(w,E),this._nativeContext=w,this._audioWorklet=i===void 0?void 0:{addModule:(b,C)=>i(this,b,C)}}get audioWorklet(){return this._audioWorklet}createAnalyser(){return new t(this)}createBiquadFilter(){return new s(this)}createBuffer(w,E,b){return new e({length:E,numberOfChannels:w,sampleRate:b})}createBufferSource(){return new n(this)}createChannelMerger(w=6){return new r(this,{numberOfInputs:w})}createChannelSplitter(w=6){return new o(this,{numberOfOutputs:w})}createConstantSource(){return new a(this)}createConvolver(){return new c(this)}createDelay(w=1){return new u(this,{maxDelayTime:w})}createDynamicsCompressor(){return new h(this)}createGain(){return new d(this)}createIIRFilter(w,E){return new m(this,{feedback:E,feedforward:w})}createOscillator(){return new g(this)}createPanner(){return new p(this)}createPeriodicWave(w,E,b={disableNormalization:!1}){return new f(this,{...b,imag:E,real:w})}createStereoPanner(){return new y(this)}createWaveShaper(){return new x(this)}decodeAudioData(w,E,b){return l(this._nativeContext,w).then(C=>(typeof E=="function"&&E(C),C),C=>{throw typeof b=="function"&&b(C),C})}},zp={Q:1,channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",detune:0,frequency:350,gain:0,type:"lowpass"},Gp=(i,t,e,n,s,r,o,a)=>class extends i{constructor(l,u){const h=r(l),d={...zp,...u},m=s(h,d),_=o(h),g=_?e():null;super(l,!1,m,g),this._Q=t(this,_,m.Q,ke,He),this._detune=t(this,_,m.detune,1200*Math.log2(ke),-1200*Math.log2(ke)),this._frequency=t(this,_,m.frequency,l.sampleRate/2,0),this._gain=t(this,_,m.gain,40*Math.log10(ke),He),this._nativeBiquadFilterNode=m,a(this,1)}get detune(){return this._detune}get frequency(){return this._frequency}get gain(){return this._gain}get Q(){return this._Q}get type(){return this._nativeBiquadFilterNode.type}set type(l){this._nativeBiquadFilterNode.type=l}getFrequencyResponse(l,u,h){try{this._nativeBiquadFilterNode.getFrequencyResponse(l,u,h)}catch(d){throw d.code===11?n():d}if(l.length!==u.length||u.length!==h.length)throw n()}},Hp=(i,t,e,n,s)=>()=>{const r=new WeakMap,o=async(a,c)=>{let l=e(a);const u=Ue(l,c);if(!u){const h={Q:l.Q.value,channelCount:l.channelCount,channelCountMode:l.channelCountMode,channelInterpretation:l.channelInterpretation,detune:l.detune.value,frequency:l.frequency.value,gain:l.gain.value,type:l.type};l=t(c,h)}return r.set(c,l),u?(await i(c,a.Q,l.Q),await i(c,a.detune,l.detune),await i(c,a.frequency,l.frequency),await i(c,a.gain,l.gain)):(await n(c,a.Q,l.Q),await n(c,a.detune,l.detune),await n(c,a.frequency,l.frequency),await n(c,a.gain,l.gain)),await s(a,c,l),l};return{render(a,c){const l=r.get(c);return l!==void 0?Promise.resolve(l):o(a,c)}}},Wp=(i,t)=>(e,n)=>{const s=t.get(e);if(s!==void 0)return s;const r=i.get(e);if(r!==void 0)return r;try{const o=n();return o instanceof Promise?(i.set(e,o),o.catch(()=>!1).then(a=>(i.delete(e),t.set(e,a),a))):(t.set(e,o),o)}catch{return t.set(e,!1),!1}},qp={channelCount:1,channelCountMode:"explicit",channelInterpretation:"speakers",numberOfInputs:6},Xp=(i,t,e,n,s)=>class extends i{constructor(o,a){const c=n(o),l={...qp,...a},u=e(c,l),h=s(c)?t():null;super(o,!1,u,h)}},Yp=(i,t,e)=>()=>{const n=new WeakMap,s=async(r,o)=>{let a=t(r);if(!Ue(a,o)){const l={channelCount:a.channelCount,channelCountMode:a.channelCountMode,channelInterpretation:a.channelInterpretation,numberOfInputs:a.numberOfInputs};a=i(o,l)}return n.set(o,a),await e(r,o,a),a};return{render(r,o){const a=n.get(o);return a!==void 0?Promise.resolve(a):s(r,o)}}},jp={channelCount:6,channelCountMode:"explicit",channelInterpretation:"discrete",numberOfOutputs:6},$p=(i,t,e,n,s,r)=>class extends i{constructor(a,c){const l=n(a),u=r({...jp,...c}),h=e(l,u),d=s(l)?t():null;super(a,!1,h,d)}},Zp=(i,t,e)=>()=>{const n=new WeakMap,s=async(r,o)=>{let a=t(r);if(!Ue(a,o)){const l={channelCount:a.channelCount,channelCountMode:a.channelCountMode,channelInterpretation:a.channelInterpretation,numberOfOutputs:a.numberOfOutputs};a=i(o,l)}return n.set(o,a),await e(r,o,a),a};return{render(r,o){const a=n.get(o);return a!==void 0?Promise.resolve(a):s(r,o)}}},Kp=i=>(t,e,n)=>i(e,t,n),Jp=i=>(t,e,n=0,s=0)=>{const r=t[n];if(r===void 0)throw i();return Go(e)?r.connect(e,0,s):r.connect(e,0)},Qp=i=>(t,e)=>{const n=i(t,{buffer:null,channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",loop:!1,loopEnd:0,loopStart:0,playbackRate:1}),s=t.createBuffer(1,2,44100);return n.buffer=s,n.loop=!0,n.connect(e),n.start(),()=>{n.stop(),n.disconnect(e)}},tm={channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",offset:1},em=(i,t,e,n,s,r,o)=>class extends i{constructor(c,l){const u=s(c),h={...tm,...l},d=n(u,h),m=r(u),_=m?e():null;super(c,!1,d,_),this._constantSourceNodeRenderer=_,this._nativeConstantSourceNode=d,this._offset=t(this,m,d.offset,ke,He),this._onended=null}get offset(){return this._offset}get onended(){return this._onended}set onended(c){const l=typeof c=="function"?o(this,c):null;this._nativeConstantSourceNode.onended=l;const u=this._nativeConstantSourceNode.onended;this._onended=u!==null&&u===l?c:u}start(c=0){if(this._nativeConstantSourceNode.start(c),this._constantSourceNodeRenderer!==null&&(this._constantSourceNodeRenderer.start=c),this.context.state!=="closed"){Os(this);const l=()=>{this._nativeConstantSourceNode.removeEventListener("ended",l),Jn(this)&&Nr(this)};this._nativeConstantSourceNode.addEventListener("ended",l)}}stop(c=0){this._nativeConstantSourceNode.stop(c),this._constantSourceNodeRenderer!==null&&(this._constantSourceNodeRenderer.stop=c)}},nm=(i,t,e,n,s)=>()=>{const r=new WeakMap;let o=null,a=null;const c=async(l,u)=>{let h=e(l);const d=Ue(h,u);if(!d){const m={channelCount:h.channelCount,channelCountMode:h.channelCountMode,channelInterpretation:h.channelInterpretation,offset:h.offset.value};h=t(u,m),o!==null&&h.start(o),a!==null&&h.stop(a)}return r.set(u,h),d?await i(u,l.offset,h.offset):await n(u,l.offset,h.offset),await s(l,u,h),h};return{set start(l){o=l},set stop(l){a=l},render(l,u){const h=r.get(u);return h!==void 0?Promise.resolve(h):c(l,u)}}},im=i=>t=>(i[0]=t,i[0]),sm={buffer:null,channelCount:2,channelCountMode:"clamped-max",channelInterpretation:"speakers",disableNormalization:!1},rm=(i,t,e,n,s,r)=>class extends i{constructor(a,c){const l=n(a),u={...sm,...c},h=e(l,u),m=s(l)?t():null;super(a,!1,h,m),this._isBufferNullified=!1,this._nativeConvolverNode=h,u.buffer!==null&&r(this,u.buffer.duration)}get buffer(){return this._isBufferNullified?null:this._nativeConvolverNode.buffer}set buffer(a){if(this._nativeConvolverNode.buffer=a,a===null&&this._nativeConvolverNode.buffer!==null){const c=this._nativeConvolverNode.context;this._nativeConvolverNode.buffer=c.createBuffer(1,1,c.sampleRate),this._isBufferNullified=!0,r(this,0)}else this._isBufferNullified=!1,r(this,this._nativeConvolverNode.buffer===null?0:this._nativeConvolverNode.buffer.duration)}get normalize(){return this._nativeConvolverNode.normalize}set normalize(a){this._nativeConvolverNode.normalize=a}},om=(i,t,e)=>()=>{const n=new WeakMap,s=async(r,o)=>{let a=t(r);if(!Ue(a,o)){const l={buffer:a.buffer,channelCount:a.channelCount,channelCountMode:a.channelCountMode,channelInterpretation:a.channelInterpretation,disableNormalization:!a.normalize};a=i(o,l)}return n.set(o,a),$s(a)?await e(r,o,a.inputs[0]):await e(r,o,a),a};return{render(r,o){const a=n.get(o);return a!==void 0?Promise.resolve(a):s(r,o)}}},am=(i,t)=>(e,n,s)=>{if(t===null)throw new Error("Missing the native OfflineAudioContext constructor.");try{return new t(e,n,s)}catch(r){throw r.name==="SyntaxError"?i():r}},cm=()=>new DOMException("","DataCloneError"),Mu=i=>{const{port1:t,port2:e}=new MessageChannel;return new Promise(n=>{const s=()=>{e.onmessage=null,t.close(),e.close(),n()};e.onmessage=()=>s();try{t.postMessage(i,[i])}catch{}finally{s()}})},lm=(i,t,e,n,s,r,o,a,c,l,u)=>(h,d)=>{const m=o(h)?h:r(h);if(s.has(d)){const _=e();return Promise.reject(_)}try{s.add(d)}catch{}return t(c,()=>c(m))?m.decodeAudioData(d).then(_=>(Mu(d).catch(()=>{}),t(a,()=>a(_))||u(_),i.add(_),_)):new Promise((_,g)=>{const p=async()=>{try{await Mu(d)}catch{}},f=y=>{g(y),p()};try{m.decodeAudioData(d,y=>{typeof y.copyFromChannel!="function"&&(l(y),gl(y)),i.add(y),p().then(()=>_(y))},y=>{f(y===null?n():y)})}catch(y){f(y)}})},um=(i,t,e,n,s,r,o,a)=>(c,l)=>{const u=t.get(c);if(u===void 0)throw new Error("Missing the expected cycle count.");const h=r(c.context),d=a(h);if(u===l){if(t.delete(c),!d&&o(c)){const m=n(c),{outputs:_}=e(c);for(const g of _)if(Or(g)){const p=n(g[0]);i(m,p,g[1],g[2])}else{const p=s(g[0]);m.connect(p,g[1])}}}else t.set(c,u-l)},hm={channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",delayTime:0,maxDelayTime:1},dm=(i,t,e,n,s,r,o)=>class extends i{constructor(c,l){const u=s(c),h={...hm,...l},d=n(u,h),m=r(u),_=m?e(h.maxDelayTime):null;super(c,!1,d,_),this._delayTime=t(this,m,d.delayTime),o(this,h.maxDelayTime)}get delayTime(){return this._delayTime}},fm=(i,t,e,n,s)=>r=>{const o=new WeakMap,a=async(c,l)=>{let u=e(c);const h=Ue(u,l);if(!h){const d={channelCount:u.channelCount,channelCountMode:u.channelCountMode,channelInterpretation:u.channelInterpretation,delayTime:u.delayTime.value,maxDelayTime:r};u=t(l,d)}return o.set(l,u),h?await i(l,c.delayTime,u.delayTime):await n(l,c.delayTime,u.delayTime),await s(c,l,u),u};return{render(c,l){const u=o.get(l);return u!==void 0?Promise.resolve(u):a(c,l)}}},pm=i=>(t,e,n,s)=>i(t[s],r=>r[0]===e&&r[1]===n),mm=i=>(t,e)=>{i(t).delete(e)},_m=i=>"delayTime"in i,gm=(i,t,e)=>function n(s,r){const o=Bo(r)?r:e(i,r);if(_m(o))return[];if(s[0]===o)return[s];if(s.includes(o))return[];const{outputs:a}=t(o);return Array.from(a).map(c=>n([...s,o],c[0])).reduce((c,l)=>c.concat(l),[])},Zr=(i,t,e)=>{const n=t[e];if(n===void 0)throw i();return n},vm=i=>(t,e=void 0,n=void 0,s=0)=>e===void 0?t.forEach(r=>r.disconnect()):typeof e=="number"?Zr(i,t,e).disconnect():Go(e)?n===void 0?t.forEach(r=>r.disconnect(e)):s===void 0?Zr(i,t,n).disconnect(e,0):Zr(i,t,n).disconnect(e,0,s):n===void 0?t.forEach(r=>r.disconnect(e)):Zr(i,t,n).disconnect(e,0),xm={attack:.003,channelCount:2,channelCountMode:"clamped-max",channelInterpretation:"speakers",knee:30,ratio:12,release:.25,threshold:-24},ym=(i,t,e,n,s,r,o,a)=>class extends i{constructor(l,u){const h=r(l),d={...xm,...u},m=n(h,d),_=o(h),g=_?e():null;super(l,!1,m,g),this._attack=t(this,_,m.attack),this._knee=t(this,_,m.knee),this._nativeDynamicsCompressorNode=m,this._ratio=t(this,_,m.ratio),this._release=t(this,_,m.release),this._threshold=t(this,_,m.threshold),a(this,.006)}get attack(){return this._attack}get channelCount(){return this._nativeDynamicsCompressorNode.channelCount}set channelCount(l){const u=this._nativeDynamicsCompressorNode.channelCount;if(this._nativeDynamicsCompressorNode.channelCount=l,l>2)throw this._nativeDynamicsCompressorNode.channelCount=u,s()}get channelCountMode(){return this._nativeDynamicsCompressorNode.channelCountMode}set channelCountMode(l){const u=this._nativeDynamicsCompressorNode.channelCountMode;if(this._nativeDynamicsCompressorNode.channelCountMode=l,l==="max")throw this._nativeDynamicsCompressorNode.channelCountMode=u,s()}get knee(){return this._knee}get ratio(){return this._ratio}get reduction(){return typeof this._nativeDynamicsCompressorNode.reduction.value=="number"?this._nativeDynamicsCompressorNode.reduction.value:this._nativeDynamicsCompressorNode.reduction}get release(){return this._release}get threshold(){return this._threshold}},Sm=(i,t,e,n,s)=>()=>{const r=new WeakMap,o=async(a,c)=>{let l=e(a);const u=Ue(l,c);if(!u){const h={attack:l.attack.value,channelCount:l.channelCount,channelCountMode:l.channelCountMode,channelInterpretation:l.channelInterpretation,knee:l.knee.value,ratio:l.ratio.value,release:l.release.value,threshold:l.threshold.value};l=t(c,h)}return r.set(c,l),u?(await i(c,a.attack,l.attack),await i(c,a.knee,l.knee),await i(c,a.ratio,l.ratio),await i(c,a.release,l.release),await i(c,a.threshold,l.threshold)):(await n(c,a.attack,l.attack),await n(c,a.knee,l.knee),await n(c,a.ratio,l.ratio),await n(c,a.release,l.release),await n(c,a.threshold,l.threshold)),await s(a,c,l),l};return{render(a,c){const l=r.get(c);return l!==void 0?Promise.resolve(l):o(a,c)}}},Mm=()=>new DOMException("","EncodingError"),Tm=i=>t=>new Promise((e,n)=>{if(i===null){n(new SyntaxError);return}const s=i.document.head;if(s===null)n(new SyntaxError);else{const r=i.document.createElement("script"),o=new Blob([t],{type:"application/javascript"}),a=URL.createObjectURL(o),c=i.onerror,l=()=>{i.onerror=c,URL.revokeObjectURL(a)};i.onerror=(u,h,d,m,_)=>{if(h===a||h===i.location.href&&d===1&&m===1)return l(),n(_),!1;if(c!==null)return c(u,h,d,m,_)},r.onerror=()=>{l(),n(new SyntaxError)},r.onload=()=>{l(),e()},r.src=a,r.type="module",s.appendChild(r)}}),Em=i=>class{constructor(e){this._nativeEventTarget=e,this._listeners=new WeakMap}addEventListener(e,n,s){if(n!==null){let r=this._listeners.get(n);r===void 0&&(r=i(this,n),typeof n=="function"&&this._listeners.set(n,r)),this._nativeEventTarget.addEventListener(e,r,s)}}dispatchEvent(e){return this._nativeEventTarget.dispatchEvent(e)}removeEventListener(e,n,s){const r=n===null?void 0:this._listeners.get(n);this._nativeEventTarget.removeEventListener(e,r===void 0?null:r,s)}},bm=i=>(t,e,n)=>{Object.defineProperties(i,{currentFrame:{configurable:!0,get(){return Math.round(t*e)}},currentTime:{configurable:!0,get(){return t}}});try{return n()}finally{i!==null&&(delete i.currentFrame,delete i.currentTime)}},wm=i=>async t=>{try{const e=await fetch(t);if(e.ok)return[await e.text(),e.url]}catch{}throw i()},Am={channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",gain:1},Cm=(i,t,e,n,s,r)=>class extends i{constructor(a,c){const l=s(a),u={...Am,...c},h=n(l,u),d=r(l),m=d?e():null;super(a,!1,h,m),this._gain=t(this,d,h.gain,ke,He)}get gain(){return this._gain}},Rm=(i,t,e,n,s)=>()=>{const r=new WeakMap,o=async(a,c)=>{let l=e(a);const u=Ue(l,c);if(!u){const h={channelCount:l.channelCount,channelCountMode:l.channelCountMode,channelInterpretation:l.channelInterpretation,gain:l.gain.value};l=t(c,h)}return r.set(c,l),u?await i(c,a.gain,l.gain):await n(c,a.gain,l.gain),await s(a,c,l),l};return{render(a,c){const l=r.get(c);return l!==void 0?Promise.resolve(l):o(a,c)}}},Dm=(i,t)=>e=>t(i,e),Pm=i=>t=>{const e=i(t);if(e.renderer===null)throw new Error("Missing the renderer of the given AudioNode in the audio graph.");return e.renderer},Im=i=>t=>{var e;return(e=i.get(t))!==null&&e!==void 0?e:0},Nm=i=>t=>{const e=i(t);if(e.renderer===null)throw new Error("Missing the renderer of the given AudioParam in the audio graph.");return e.renderer},Lm=i=>t=>i.get(t),Ce=()=>new DOMException("","InvalidStateError"),Om=i=>t=>{const e=i.get(t);if(e===void 0)throw Ce();return e},Um=(i,t)=>e=>{let n=i.get(e);if(n!==void 0)return n;if(t===null)throw new Error("Missing the native OfflineAudioContext constructor.");return n=new t(1,1,44100),i.set(e,n),n},Fm=i=>t=>{const e=i.get(t);if(e===void 0)throw new Error("The context has no set of AudioWorkletNodes.");return e},Ta=()=>new DOMException("","InvalidAccessError"),km=i=>{i.getFrequencyResponse=(t=>(e,n,s)=>{if(e.length!==n.length||n.length!==s.length)throw Ta();return t.call(i,e,n,s)})(i.getFrequencyResponse)},Bm={channelCount:2,channelCountMode:"max",channelInterpretation:"speakers"},Vm=(i,t,e,n,s,r)=>class extends i{constructor(a,c){const l=n(a),u=s(l),h={...Bm,...c},d=t(l,u?null:a.baseLatency,h),m=u?e(h.feedback,h.feedforward):null;super(a,!1,d,m),km(d),this._nativeIIRFilterNode=d,r(this,1)}getFrequencyResponse(a,c,l){return this._nativeIIRFilterNode.getFrequencyResponse(a,c,l)}},Zh=(i,t,e,n,s,r,o,a,c,l,u)=>{const h=l.length;let d=a;for(let m=0;m<h;m+=1){let _=e[0]*l[m];for(let g=1;g<s;g+=1){const p=d-g&c-1;_+=e[g]*r[p],_-=i[g]*o[p]}for(let g=s;g<n;g+=1)_+=e[g]*r[d-g&c-1];for(let g=s;g<t;g+=1)_-=i[g]*o[d-g&c-1];r[d]=l[m],o[d]=_,d=d+1&c-1,u[m]=_}return d},zm=(i,t,e,n)=>{const s=e instanceof Float64Array?e:new Float64Array(e),r=n instanceof Float64Array?n:new Float64Array(n),o=s.length,a=r.length,c=Math.min(o,a);if(s[0]!==1){for(let _=0;_<o;_+=1)r[_]/=s[0];for(let _=1;_<a;_+=1)s[_]/=s[0]}const l=32,u=new Float32Array(l),h=new Float32Array(l),d=t.createBuffer(i.numberOfChannels,i.length,i.sampleRate),m=i.numberOfChannels;for(let _=0;_<m;_+=1){const g=i.getChannelData(_),p=d.getChannelData(_);u.fill(0),h.fill(0),Zh(s,o,r,a,c,u,h,0,l,g,p)}return d},Gm=(i,t,e,n,s)=>(r,o)=>{const a=new WeakMap;let c=null;const l=async(u,h)=>{let d=null,m=t(u);const _=Ue(m,h);if(h.createIIRFilter===void 0?d=i(h,{buffer:null,channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",loop:!1,loopEnd:0,loopStart:0,playbackRate:1}):_||(m=h.createIIRFilter(o,r)),a.set(h,d===null?m:d),d!==null){if(c===null){if(e===null)throw new Error("Missing the native OfflineAudioContext constructor.");const p=new e(u.context.destination.channelCount,u.context.length,h.sampleRate);c=(async()=>{await n(u,p,p.destination);const f=await s(p);return zm(f,h,r,o)})()}const g=await c;return d.buffer=g,d.start(0),d}return await n(u,h,m),m};return{render(u,h){const d=a.get(h);return d!==void 0?Promise.resolve(d):l(u,h)}}},Hm=(i,t,e,n,s,r)=>o=>(a,c)=>{const l=i.get(a);if(l===void 0){if(!o&&r(a)){const u=n(a),{outputs:h}=e(a);for(const d of h)if(Or(d)){const m=n(d[0]);t(u,m,d[1],d[2])}else{const m=s(d[0]);u.disconnect(m,d[1])}}i.set(a,c)}else i.set(a,l+c)},Wm=(i,t)=>e=>{const n=i.get(e);return t(n)||t(e)},qm=(i,t)=>e=>i.has(e)||t(e),Xm=(i,t)=>e=>i.has(e)||t(e),Ym=(i,t)=>e=>{const n=i.get(e);return t(n)||t(e)},jm=i=>t=>i!==null&&t instanceof i,$m=i=>t=>i!==null&&typeof i.AudioNode=="function"&&t instanceof i.AudioNode,Zm=i=>t=>i!==null&&typeof i.AudioParam=="function"&&t instanceof i.AudioParam,Km=(i,t)=>e=>i(e)||t(e),Jm=i=>t=>i!==null&&t instanceof i,Qm=i=>i!==null&&i.isSecureContext,t_=(i,t,e,n)=>class extends i{constructor(r,o){const a=e(r),c=t(a,o);if(n(a))throw TypeError();super(r,!0,c,null),this._nativeMediaElementAudioSourceNode=c}get mediaElement(){return this._nativeMediaElementAudioSourceNode.mediaElement}},e_={channelCount:2,channelCountMode:"explicit",channelInterpretation:"speakers"},n_=(i,t,e,n)=>class extends i{constructor(r,o){const a=e(r);if(n(a))throw new TypeError;const c={...e_,...o},l=t(a,c);super(r,!1,l,null),this._nativeMediaStreamAudioDestinationNode=l}get stream(){return this._nativeMediaStreamAudioDestinationNode.stream}},i_=(i,t,e,n)=>class extends i{constructor(r,o){const a=e(r),c=t(a,o);if(n(a))throw new TypeError;super(r,!0,c,null),this._nativeMediaStreamAudioSourceNode=c}get mediaStream(){return this._nativeMediaStreamAudioSourceNode.mediaStream}},s_=(i,t,e)=>class extends i{constructor(s,r){const o=e(s),a=t(o,r);super(s,!0,a,null)}},r_=(i,t,e,n,s,r)=>class extends e{constructor(a,c){super(a),this._nativeContext=a,Sa.set(this,a),n(a)&&s.set(a,new Set),this._destination=new i(this,c),this._listener=t(this,a),this._onstatechange=null}get currentTime(){return this._nativeContext.currentTime}get destination(){return this._destination}get listener(){return this._listener}get onstatechange(){return this._onstatechange}set onstatechange(a){const c=typeof a=="function"?r(this,a):null;this._nativeContext.onstatechange=c;const l=this._nativeContext.onstatechange;this._onstatechange=l!==null&&l===c?a:l}get sampleRate(){return this._nativeContext.sampleRate}get state(){return this._nativeContext.state}},mr=i=>{const t=new Uint32Array([1179011410,40,1163280727,544501094,16,131073,44100,176400,1048580,1635017060,4,0]);try{const e=i.decodeAudioData(t.buffer,()=>{});return e===void 0?!1:(e.catch(()=>{}),!0)}catch{}return!1},o_=(i,t)=>(e,n,s)=>{const r=new Set;return e.connect=(o=>(a,c=0,l=0)=>{const u=r.size===0;if(t(a))return o.call(e,a,c,l),i(r,[a,c,l],h=>h[0]===a&&h[1]===c&&h[2]===l,!0),u&&n(),a;o.call(e,a,c),i(r,[a,c],h=>h[0]===a&&h[1]===c,!0),u&&n()})(e.connect),e.disconnect=(o=>(a,c,l)=>{const u=r.size>0;if(a===void 0)o.apply(e),r.clear();else if(typeof a=="number"){o.call(e,a);for(const d of r)d[1]===a&&r.delete(d)}else{t(a)?o.call(e,a,c,l):o.call(e,a,c);for(const d of r)d[0]===a&&(c===void 0||d[1]===c)&&(l===void 0||d[2]===l)&&r.delete(d)}const h=r.size===0;u&&h&&s()})(e.disconnect),e},le=(i,t,e)=>{const n=t[e];n!==void 0&&n!==i[e]&&(i[e]=n)},Te=(i,t)=>{le(i,t,"channelCount"),le(i,t,"channelCountMode"),le(i,t,"channelInterpretation")},Tu=i=>typeof i.getFloatTimeDomainData=="function",a_=i=>{i.getFloatTimeDomainData=t=>{const e=new Uint8Array(t.length);i.getByteTimeDomainData(e);const n=Math.max(e.length,i.fftSize);for(let s=0;s<n;s+=1)t[s]=(e[s]-128)*.0078125;return t}},c_=(i,t)=>(e,n)=>{const s=e.createAnalyser();if(Te(s,n),!(n.maxDecibels>n.minDecibels))throw t();return le(s,n,"fftSize"),le(s,n,"maxDecibels"),le(s,n,"minDecibels"),le(s,n,"smoothingTimeConstant"),i(Tu,()=>Tu(s))||a_(s),s},l_=i=>i===null?null:i.hasOwnProperty("AudioBuffer")?i.AudioBuffer:null,me=(i,t,e)=>{const n=t[e];n!==void 0&&n!==i[e].value&&(i[e].value=n)},u_=i=>{i.start=(t=>{let e=!1;return(n=0,s=0,r)=>{if(e)throw Ce();t.call(i,n,s,r),e=!0}})(i.start)},yl=i=>{i.start=(t=>(e=0,n=0,s)=>{if(typeof s=="number"&&s<0||n<0||e<0)throw new RangeError("The parameters can't be negative.");t.call(i,e,n,s)})(i.start)},Sl=i=>{i.stop=(t=>(e=0)=>{if(e<0)throw new RangeError("The parameter can't be negative.");t.call(i,e)})(i.stop)},h_=(i,t,e,n,s,r,o,a,c,l,u)=>(h,d)=>{const m=h.createBufferSource();return Te(m,d),me(m,d,"playbackRate"),le(m,d,"buffer"),le(m,d,"loop"),le(m,d,"loopEnd"),le(m,d,"loopStart"),t(e,()=>e(h))||u_(m),t(n,()=>n(h))||c(m),t(s,()=>s(h))||l(m,h),t(r,()=>r(h))||yl(m),t(o,()=>o(h))||u(m,h),t(a,()=>a(h))||Sl(m),i(h,m),m},d_=i=>i===null?null:i.hasOwnProperty("AudioContext")?i.AudioContext:i.hasOwnProperty("webkitAudioContext")?i.webkitAudioContext:null,f_=(i,t)=>(e,n,s)=>{const r=e.destination;if(r.channelCount!==n)try{r.channelCount=n}catch{}s&&r.channelCountMode!=="explicit"&&(r.channelCountMode="explicit"),r.maxChannelCount===0&&Object.defineProperty(r,"maxChannelCount",{value:n});const o=i(e,{channelCount:n,channelCountMode:r.channelCountMode,channelInterpretation:r.channelInterpretation,gain:1});return t(o,"channelCount",a=>()=>a.call(o),a=>c=>{a.call(o,c);try{r.channelCount=c}catch(l){if(c>r.maxChannelCount)throw l}}),t(o,"channelCountMode",a=>()=>a.call(o),a=>c=>{a.call(o,c),r.channelCountMode=c}),t(o,"channelInterpretation",a=>()=>a.call(o),a=>c=>{a.call(o,c),r.channelInterpretation=c}),Object.defineProperty(o,"maxChannelCount",{get:()=>r.maxChannelCount}),o.connect(r),o},p_=i=>i===null?null:i.hasOwnProperty("AudioWorkletNode")?i.AudioWorkletNode:null,m_=i=>{const{port1:t}=new MessageChannel;try{t.postMessage(i)}finally{t.close()}},__=(i,t,e,n,s)=>(r,o,a,c,l,u)=>{if(a!==null)try{const h=new a(r,c,u),d=new Map;let m=null;if(Object.defineProperties(h,{channelCount:{get:()=>u.channelCount,set:()=>{throw i()}},channelCountMode:{get:()=>"explicit",set:()=>{throw i()}},onprocessorerror:{get:()=>m,set:_=>{typeof m=="function"&&h.removeEventListener("processorerror",m),m=typeof _=="function"?_:null,typeof m=="function"&&h.addEventListener("processorerror",m)}}}),h.addEventListener=(_=>(...g)=>{if(g[0]==="processorerror"){const p=typeof g[1]=="function"?g[1]:typeof g[1]=="object"&&g[1]!==null&&typeof g[1].handleEvent=="function"?g[1].handleEvent:null;if(p!==null){const f=d.get(g[1]);f!==void 0?g[1]=f:(g[1]=y=>{y.type==="error"?(Object.defineProperties(y,{type:{value:"processorerror"}}),p(y)):p(new ErrorEvent(g[0],{...y}))},d.set(p,g[1]))}}return _.call(h,"error",g[1],g[2]),_.call(h,...g)})(h.addEventListener),h.removeEventListener=(_=>(...g)=>{if(g[0]==="processorerror"){const p=d.get(g[1]);p!==void 0&&(d.delete(g[1]),g[1]=p)}return _.call(h,"error",g[1],g[2]),_.call(h,g[0],g[1],g[2])})(h.removeEventListener),u.numberOfOutputs!==0){const _=e(r,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",gain:0});return h.connect(_).connect(r.destination),s(h,()=>_.disconnect(),()=>_.connect(r.destination))}return h}catch(h){throw h.code===11?n():h}if(l===void 0)throw n();return m_(u),t(r,o,l,u)},Kh=(i,t)=>i===null?512:Math.max(512,Math.min(16384,Math.pow(2,Math.round(Math.log2(i*t))))),g_=i=>new Promise((t,e)=>{const{port1:n,port2:s}=new MessageChannel;n.onmessage=({data:r})=>{n.close(),s.close(),t(r)},n.onmessageerror=({data:r})=>{n.close(),s.close(),e(r)},s.postMessage(i)}),v_=async(i,t)=>{const e=await g_(t);return new i(e)},x_=(i,t,e,n)=>{let s=Cc.get(i);s===void 0&&(s=new WeakMap,Cc.set(i,s));const r=v_(e,n);return s.set(t,r),r},y_=(i,t,e,n,s,r,o,a,c,l,u,h,d)=>(m,_,g,p)=>{if(p.numberOfInputs===0&&p.numberOfOutputs===0)throw c();const f=Array.isArray(p.outputChannelCount)?p.outputChannelCount:Array.from(p.outputChannelCount);if(f.some(rt=>rt<1))throw c();if(f.length!==p.numberOfOutputs)throw t();if(p.channelCountMode!=="explicit")throw c();const y=p.channelCount*p.numberOfInputs,x=f.reduce((rt,it)=>rt+it,0),T=g.parameterDescriptors===void 0?0:g.parameterDescriptors.length;if(y+T>6||x>6)throw c();const w=new MessageChannel,E=[],b=[];for(let rt=0;rt<p.numberOfInputs;rt+=1)E.push(o(m,{channelCount:p.channelCount,channelCountMode:p.channelCountMode,channelInterpretation:p.channelInterpretation,gain:1})),b.push(s(m,{channelCount:p.channelCount,channelCountMode:"explicit",channelInterpretation:"discrete",numberOfOutputs:p.channelCount}));const C=[];if(g.parameterDescriptors!==void 0)for(const{defaultValue:rt,maxValue:it,minValue:Ut,name:_t}of g.parameterDescriptors){const ft=r(m,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",offset:p.parameterData[_t]!==void 0?p.parameterData[_t]:rt===void 0?0:rt});Object.defineProperties(ft.offset,{defaultValue:{get:()=>rt===void 0?0:rt},maxValue:{get:()=>it===void 0?ke:it},minValue:{get:()=>Ut===void 0?He:Ut}}),C.push(ft)}const S=n(m,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"speakers",numberOfInputs:Math.max(1,y+T)}),v=Kh(_,m.sampleRate),R=a(m,v,y+T,Math.max(1,x)),P=s(m,{channelCount:Math.max(1,x),channelCountMode:"explicit",channelInterpretation:"discrete",numberOfOutputs:Math.max(1,x)}),N=[];for(let rt=0;rt<p.numberOfOutputs;rt+=1)N.push(n(m,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"speakers",numberOfInputs:f[rt]}));for(let rt=0;rt<p.numberOfInputs;rt+=1){E[rt].connect(b[rt]);for(let it=0;it<p.channelCount;it+=1)b[rt].connect(S,it,rt*p.channelCount+it)}const F=new jh(g.parameterDescriptors===void 0?[]:g.parameterDescriptors.map(({name:rt},it)=>{const Ut=C[it];return Ut.connect(S,0,y+it),Ut.start(0),[rt,Ut.offset]}));S.connect(R);let z=p.channelInterpretation,U=null;const B=p.numberOfOutputs===0?[R]:N,V={get bufferSize(){return v},get channelCount(){return p.channelCount},set channelCount(rt){throw e()},get channelCountMode(){return p.channelCountMode},set channelCountMode(rt){throw e()},get channelInterpretation(){return z},set channelInterpretation(rt){for(const it of E)it.channelInterpretation=rt;z=rt},get context(){return R.context},get inputs(){return E},get numberOfInputs(){return p.numberOfInputs},get numberOfOutputs(){return p.numberOfOutputs},get onprocessorerror(){return U},set onprocessorerror(rt){typeof U=="function"&&V.removeEventListener("processorerror",U),U=typeof rt=="function"?rt:null,typeof U=="function"&&V.addEventListener("processorerror",U)},get parameters(){return F},get port(){return w.port2},addEventListener(...rt){return R.addEventListener(rt[0],rt[1],rt[2])},connect:i.bind(null,B),disconnect:l.bind(null,B),dispatchEvent(...rt){return R.dispatchEvent(rt[0])},removeEventListener(...rt){return R.removeEventListener(rt[0],rt[1],rt[2])}},j=new Map;w.port1.addEventListener=(rt=>(...it)=>{if(it[0]==="message"){const Ut=typeof it[1]=="function"?it[1]:typeof it[1]=="object"&&it[1]!==null&&typeof it[1].handleEvent=="function"?it[1].handleEvent:null;if(Ut!==null){const _t=j.get(it[1]);_t!==void 0?it[1]=_t:(it[1]=ft=>{u(m.currentTime,m.sampleRate,()=>Ut(ft))},j.set(Ut,it[1]))}}return rt.call(w.port1,it[0],it[1],it[2])})(w.port1.addEventListener),w.port1.removeEventListener=(rt=>(...it)=>{if(it[0]==="message"){const Ut=j.get(it[1]);Ut!==void 0&&(j.delete(it[1]),it[1]=Ut)}return rt.call(w.port1,it[0],it[1],it[2])})(w.port1.removeEventListener);let J=null;Object.defineProperty(w.port1,"onmessage",{get:()=>J,set:rt=>{typeof J=="function"&&w.port1.removeEventListener("message",J),J=typeof rt=="function"?rt:null,typeof J=="function"&&(w.port1.addEventListener("message",J),w.port1.start())}}),g.prototype.port=w.port1;let nt=null;x_(m,V,g,p).then(rt=>nt=rt);const Ot=Wo(p.numberOfInputs,p.channelCount),X=Wo(p.numberOfOutputs,f),Y=g.parameterDescriptors===void 0?[]:g.parameterDescriptors.reduce((rt,{name:it})=>({...rt,[it]:new Float32Array(128)}),{});let ot=!0;const ut=()=>{p.numberOfOutputs>0&&R.disconnect(P);for(let rt=0,it=0;rt<p.numberOfOutputs;rt+=1){const Ut=N[rt];for(let _t=0;_t<f[rt];_t+=1)P.disconnect(Ut,it+_t,_t);it+=f[rt]}},st=new Map;R.onaudioprocess=({inputBuffer:rt,outputBuffer:it})=>{if(nt!==null){const Ut=h(V);for(let _t=0;_t<v;_t+=128){for(let ft=0;ft<p.numberOfInputs;ft+=1)for(let D=0;D<p.channelCount;D+=1)Ho(rt,Ot[ft],D,D,_t);g.parameterDescriptors!==void 0&&g.parameterDescriptors.forEach(({name:ft},D)=>{Ho(rt,Y,ft,y+D,_t)});for(let ft=0;ft<p.numberOfInputs;ft+=1)for(let D=0;D<f[ft];D+=1)X[ft][D].byteLength===0&&(X[ft][D]=new Float32Array(128));try{const ft=Ot.map((M,H)=>{if(Ut[H].size>0)return st.set(H,v/128),M;const et=st.get(H);return et===void 0?[]:(M.every(tt=>tt.every(wt=>wt===0))&&(et===1?st.delete(H):st.set(H,et-1)),M)});ot=u(m.currentTime+_t/m.sampleRate,m.sampleRate,()=>nt.process(ft,X,Y));for(let M=0,H=0;M<p.numberOfOutputs;M+=1){for(let Z=0;Z<f[M];Z+=1)$h(it,X[M],Z,H+Z,_t);H+=f[M]}}catch(ft){ot=!1,V.dispatchEvent(new ErrorEvent("processorerror",{colno:ft.colno,filename:ft.filename,lineno:ft.lineno,message:ft.message}))}if(!ot){for(let ft=0;ft<p.numberOfInputs;ft+=1){E[ft].disconnect(b[ft]);for(let D=0;D<p.channelCount;D+=1)b[_t].disconnect(S,D,ft*p.channelCount+D)}if(g.parameterDescriptors!==void 0){const ft=g.parameterDescriptors.length;for(let D=0;D<ft;D+=1){const M=C[D];M.disconnect(S,0,y+D),M.stop()}}S.disconnect(R),R.onaudioprocess=null,Ct?ut():I();break}}}};let Ct=!1;const Nt=o(m,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",gain:0}),ne=()=>R.connect(Nt).connect(m.destination),I=()=>{R.disconnect(Nt),Nt.disconnect()},de=()=>{if(ot){I(),p.numberOfOutputs>0&&R.connect(P);for(let rt=0,it=0;rt<p.numberOfOutputs;rt+=1){const Ut=N[rt];for(let _t=0;_t<f[rt];_t+=1)P.connect(Ut,it+_t,_t);it+=f[rt]}}Ct=!0},Zt=()=>{ot&&(ne(),ut()),Ct=!1};return ne(),d(V,de,Zt)},Jh=(i,t)=>{const e=i.createBiquadFilter();return Te(e,t),me(e,t,"Q"),me(e,t,"detune"),me(e,t,"frequency"),me(e,t,"gain"),le(e,t,"type"),e},S_=(i,t)=>(e,n)=>{const s=e.createChannelMerger(n.numberOfInputs);return i!==null&&i.name==="webkitAudioContext"&&t(e,s),Te(s,n),s},M_=i=>{const t=i.numberOfOutputs;Object.defineProperty(i,"channelCount",{get:()=>t,set:e=>{if(e!==t)throw Ce()}}),Object.defineProperty(i,"channelCountMode",{get:()=>"explicit",set:e=>{if(e!=="explicit")throw Ce()}}),Object.defineProperty(i,"channelInterpretation",{get:()=>"discrete",set:e=>{if(e!=="discrete")throw Ce()}})},Ur=(i,t)=>{const e=i.createChannelSplitter(t.numberOfOutputs);return Te(e,t),M_(e),e},T_=(i,t,e,n,s)=>(r,o)=>{if(r.createConstantSource===void 0)return e(r,o);const a=r.createConstantSource();return Te(a,o),me(a,o,"offset"),t(n,()=>n(r))||yl(a),t(s,()=>s(r))||Sl(a),i(r,a),a},Zs=(i,t)=>(i.connect=t.connect.bind(t),i.disconnect=t.disconnect.bind(t),i),E_=(i,t,e,n)=>(s,{offset:r,...o})=>{const a=s.createBuffer(1,2,44100),c=t(s,{buffer:null,channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",loop:!1,loopEnd:0,loopStart:0,playbackRate:1}),l=e(s,{...o,gain:r}),u=a.getChannelData(0);u[0]=1,u[1]=1,c.buffer=a,c.loop=!0;const h={get bufferSize(){},get channelCount(){return l.channelCount},set channelCount(_){l.channelCount=_},get channelCountMode(){return l.channelCountMode},set channelCountMode(_){l.channelCountMode=_},get channelInterpretation(){return l.channelInterpretation},set channelInterpretation(_){l.channelInterpretation=_},get context(){return l.context},get inputs(){return[]},get numberOfInputs(){return c.numberOfInputs},get numberOfOutputs(){return l.numberOfOutputs},get offset(){return l.gain},get onended(){return c.onended},set onended(_){c.onended=_},addEventListener(..._){return c.addEventListener(_[0],_[1],_[2])},dispatchEvent(..._){return c.dispatchEvent(_[0])},removeEventListener(..._){return c.removeEventListener(_[0],_[1],_[2])},start(_=0){c.start.call(c,_)},stop(_=0){c.stop.call(c,_)}},d=()=>c.connect(l),m=()=>c.disconnect(l);return i(s,c),n(Zs(h,l),d,m)},b_=(i,t)=>(e,n)=>{const s=e.createConvolver();if(Te(s,n),n.disableNormalization===s.normalize&&(s.normalize=!n.disableNormalization),le(s,n,"buffer"),n.channelCount>2||(t(s,"channelCount",r=>()=>r.call(s),r=>o=>{if(o>2)throw i();return r.call(s,o)}),n.channelCountMode==="max"))throw i();return t(s,"channelCountMode",r=>()=>r.call(s),r=>o=>{if(o==="max")throw i();return r.call(s,o)}),s},Qh=(i,t)=>{const e=i.createDelay(t.maxDelayTime);return Te(e,t),me(e,t,"delayTime"),e},w_=i=>(t,e)=>{const n=t.createDynamicsCompressor();if(Te(n,e),e.channelCount>2||e.channelCountMode==="max")throw i();return me(n,e,"attack"),me(n,e,"knee"),me(n,e,"ratio"),me(n,e,"release"),me(n,e,"threshold"),n},Ye=(i,t)=>{const e=i.createGain();return Te(e,t),me(e,t,"gain"),e},A_=i=>(t,e,n)=>{if(t.createIIRFilter===void 0)return i(t,e,n);const s=t.createIIRFilter(n.feedforward,n.feedback);return Te(s,n),s};function C_(i,t){const e=t[0]*t[0]+t[1]*t[1];return[(i[0]*t[0]+i[1]*t[1])/e,(i[1]*t[0]-i[0]*t[1])/e]}function R_(i,t){return[i[0]*t[0]-i[1]*t[1],i[0]*t[1]+i[1]*t[0]]}function Eu(i,t){let e=[0,0];for(let n=i.length-1;n>=0;n-=1)e=R_(e,t),e[0]+=i[n];return e}const D_=(i,t,e,n)=>(s,r,{channelCount:o,channelCountMode:a,channelInterpretation:c,feedback:l,feedforward:u})=>{const h=Kh(r,s.sampleRate),d=l instanceof Float64Array?l:new Float64Array(l),m=u instanceof Float64Array?u:new Float64Array(u),_=d.length,g=m.length,p=Math.min(_,g);if(_===0||_>20)throw n();if(d[0]===0)throw t();if(g===0||g>20)throw n();if(m[0]===0)throw t();if(d[0]!==1){for(let C=0;C<g;C+=1)m[C]/=d[0];for(let C=1;C<_;C+=1)d[C]/=d[0]}const f=e(s,h,o,o);f.channelCount=o,f.channelCountMode=a,f.channelInterpretation=c;const y=32,x=[],T=[],w=[];for(let C=0;C<o;C+=1){x.push(0);const S=new Float32Array(y),v=new Float32Array(y);S.fill(0),v.fill(0),T.push(S),w.push(v)}f.onaudioprocess=C=>{const S=C.inputBuffer,v=C.outputBuffer,R=S.numberOfChannels;for(let P=0;P<R;P+=1){const N=S.getChannelData(P),F=v.getChannelData(P);x[P]=Zh(d,_,m,g,p,T[P],w[P],x[P],y,N,F)}};const E=s.sampleRate/2;return Zs({get bufferSize(){return h},get channelCount(){return f.channelCount},set channelCount(C){f.channelCount=C},get channelCountMode(){return f.channelCountMode},set channelCountMode(C){f.channelCountMode=C},get channelInterpretation(){return f.channelInterpretation},set channelInterpretation(C){f.channelInterpretation=C},get context(){return f.context},get inputs(){return[f]},get numberOfInputs(){return f.numberOfInputs},get numberOfOutputs(){return f.numberOfOutputs},addEventListener(...C){return f.addEventListener(C[0],C[1],C[2])},dispatchEvent(...C){return f.dispatchEvent(C[0])},getFrequencyResponse(C,S,v){if(C.length!==S.length||S.length!==v.length)throw i();const R=C.length;for(let P=0;P<R;P+=1){const N=-Math.PI*(C[P]/E),F=[Math.cos(N),Math.sin(N)],z=Eu(m,F),U=Eu(d,F),B=C_(z,U);S[P]=Math.sqrt(B[0]*B[0]+B[1]*B[1]),v[P]=Math.atan2(B[1],B[0])}},removeEventListener(...C){return f.removeEventListener(C[0],C[1],C[2])}},f)},P_=(i,t)=>i.createMediaElementSource(t.mediaElement),I_=(i,t)=>{const e=i.createMediaStreamDestination();return Te(e,t),e.numberOfOutputs===1&&Object.defineProperty(e,"numberOfOutputs",{get:()=>0}),e},N_=(i,{mediaStream:t})=>{const e=t.getAudioTracks();e.sort((r,o)=>r.id<o.id?-1:r.id>o.id?1:0);const n=e.slice(0,1),s=i.createMediaStreamSource(new MediaStream(n));return Object.defineProperty(s,"mediaStream",{value:t}),s},L_=(i,t)=>(e,{mediaStreamTrack:n})=>{if(typeof e.createMediaStreamTrackSource=="function")return e.createMediaStreamTrackSource(n);const s=new MediaStream([n]),r=e.createMediaStreamSource(s);if(n.kind!=="audio")throw i();if(t(e))throw new TypeError;return r},O_=i=>i===null?null:i.hasOwnProperty("OfflineAudioContext")?i.OfflineAudioContext:i.hasOwnProperty("webkitOfflineAudioContext")?i.webkitOfflineAudioContext:null,U_=(i,t,e,n,s,r)=>(o,a)=>{const c=o.createOscillator();return Te(c,a),me(c,a,"detune"),me(c,a,"frequency"),a.periodicWave!==void 0?c.setPeriodicWave(a.periodicWave):le(c,a,"type"),t(e,()=>e(o))||yl(c),t(n,()=>n(o))||r(c,o),t(s,()=>s(o))||Sl(c),i(o,c),c},F_=i=>(t,e)=>{const n=t.createPanner();return n.orientationX===void 0?i(t,e):(Te(n,e),me(n,e,"orientationX"),me(n,e,"orientationY"),me(n,e,"orientationZ"),me(n,e,"positionX"),me(n,e,"positionY"),me(n,e,"positionZ"),le(n,e,"coneInnerAngle"),le(n,e,"coneOuterAngle"),le(n,e,"coneOuterGain"),le(n,e,"distanceModel"),le(n,e,"maxDistance"),le(n,e,"panningModel"),le(n,e,"refDistance"),le(n,e,"rolloffFactor"),n)},k_=(i,t,e,n,s,r,o,a,c,l)=>(u,{coneInnerAngle:h,coneOuterAngle:d,coneOuterGain:m,distanceModel:_,maxDistance:g,orientationX:p,orientationY:f,orientationZ:y,panningModel:x,positionX:T,positionY:w,positionZ:E,refDistance:b,rolloffFactor:C,...S})=>{const v=u.createPanner();if(S.channelCount>2||S.channelCountMode==="max")throw o();Te(v,S);const R={channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete"},P=e(u,{...R,channelInterpretation:"speakers",numberOfInputs:6}),N=n(u,{...S,gain:1}),F=n(u,{...R,gain:1}),z=n(u,{...R,gain:0}),U=n(u,{...R,gain:0}),B=n(u,{...R,gain:0}),V=n(u,{...R,gain:0}),j=n(u,{...R,gain:0}),J=s(u,256,6,1),nt=r(u,{...R,curve:new Float32Array([1,1]),oversample:"none"});let xt=[p,f,y],Ot=[T,w,E];const X=new Float32Array(1);J.onaudioprocess=({inputBuffer:st})=>{const Ct=[c(st,X,0),c(st,X,1),c(st,X,2)];Ct.some((ne,I)=>ne!==xt[I])&&(v.setOrientation(...Ct),xt=Ct);const Nt=[c(st,X,3),c(st,X,4),c(st,X,5)];Nt.some((ne,I)=>ne!==Ot[I])&&(v.setPosition(...Nt),Ot=Nt)},Object.defineProperty(z.gain,"defaultValue",{get:()=>0}),Object.defineProperty(U.gain,"defaultValue",{get:()=>0}),Object.defineProperty(B.gain,"defaultValue",{get:()=>0}),Object.defineProperty(V.gain,"defaultValue",{get:()=>0}),Object.defineProperty(j.gain,"defaultValue",{get:()=>0});const Y={get bufferSize(){},get channelCount(){return v.channelCount},set channelCount(st){if(st>2)throw o();N.channelCount=st,v.channelCount=st},get channelCountMode(){return v.channelCountMode},set channelCountMode(st){if(st==="max")throw o();N.channelCountMode=st,v.channelCountMode=st},get channelInterpretation(){return v.channelInterpretation},set channelInterpretation(st){N.channelInterpretation=st,v.channelInterpretation=st},get coneInnerAngle(){return v.coneInnerAngle},set coneInnerAngle(st){v.coneInnerAngle=st},get coneOuterAngle(){return v.coneOuterAngle},set coneOuterAngle(st){v.coneOuterAngle=st},get coneOuterGain(){return v.coneOuterGain},set coneOuterGain(st){if(st<0||st>1)throw t();v.coneOuterGain=st},get context(){return v.context},get distanceModel(){return v.distanceModel},set distanceModel(st){v.distanceModel=st},get inputs(){return[N]},get maxDistance(){return v.maxDistance},set maxDistance(st){if(st<0)throw new RangeError;v.maxDistance=st},get numberOfInputs(){return v.numberOfInputs},get numberOfOutputs(){return v.numberOfOutputs},get orientationX(){return F.gain},get orientationY(){return z.gain},get orientationZ(){return U.gain},get panningModel(){return v.panningModel},set panningModel(st){v.panningModel=st},get positionX(){return B.gain},get positionY(){return V.gain},get positionZ(){return j.gain},get refDistance(){return v.refDistance},set refDistance(st){if(st<0)throw new RangeError;v.refDistance=st},get rolloffFactor(){return v.rolloffFactor},set rolloffFactor(st){if(st<0)throw new RangeError;v.rolloffFactor=st},addEventListener(...st){return N.addEventListener(st[0],st[1],st[2])},dispatchEvent(...st){return N.dispatchEvent(st[0])},removeEventListener(...st){return N.removeEventListener(st[0],st[1],st[2])}};h!==Y.coneInnerAngle&&(Y.coneInnerAngle=h),d!==Y.coneOuterAngle&&(Y.coneOuterAngle=d),m!==Y.coneOuterGain&&(Y.coneOuterGain=m),_!==Y.distanceModel&&(Y.distanceModel=_),g!==Y.maxDistance&&(Y.maxDistance=g),p!==Y.orientationX.value&&(Y.orientationX.value=p),f!==Y.orientationY.value&&(Y.orientationY.value=f),y!==Y.orientationZ.value&&(Y.orientationZ.value=y),x!==Y.panningModel&&(Y.panningModel=x),T!==Y.positionX.value&&(Y.positionX.value=T),w!==Y.positionY.value&&(Y.positionY.value=w),E!==Y.positionZ.value&&(Y.positionZ.value=E),b!==Y.refDistance&&(Y.refDistance=b),C!==Y.rolloffFactor&&(Y.rolloffFactor=C),(xt[0]!==1||xt[1]!==0||xt[2]!==0)&&v.setOrientation(...xt),(Ot[0]!==0||Ot[1]!==0||Ot[2]!==0)&&v.setPosition(...Ot);const ot=()=>{N.connect(v),i(N,nt,0,0),nt.connect(F).connect(P,0,0),nt.connect(z).connect(P,0,1),nt.connect(U).connect(P,0,2),nt.connect(B).connect(P,0,3),nt.connect(V).connect(P,0,4),nt.connect(j).connect(P,0,5),P.connect(J).connect(u.destination)},ut=()=>{N.disconnect(v),a(N,nt,0,0),nt.disconnect(F),F.disconnect(P),nt.disconnect(z),z.disconnect(P),nt.disconnect(U),U.disconnect(P),nt.disconnect(B),B.disconnect(P),nt.disconnect(V),V.disconnect(P),nt.disconnect(j),j.disconnect(P),P.disconnect(J),J.disconnect(u.destination)};return l(Zs(Y,v),ot,ut)},B_=i=>(t,{disableNormalization:e,imag:n,real:s})=>{const r=n instanceof Float32Array?n:new Float32Array(n),o=s instanceof Float32Array?s:new Float32Array(s),a=t.createPeriodicWave(o,r,{disableNormalization:e});if(Array.from(n).length<2)throw i();return a},Fr=(i,t,e,n)=>i.createScriptProcessor(t,e,n),V_=(i,t)=>(e,n)=>{const s=n.channelCountMode;if(s==="clamped-max")throw t();if(e.createStereoPanner===void 0)return i(e,n);const r=e.createStereoPanner();return Te(r,n),me(r,n,"pan"),Object.defineProperty(r,"channelCountMode",{get:()=>s,set:o=>{if(o!==s)throw t()}}),r},z_=(i,t,e,n,s,r)=>{const a=new Float32Array([1,1]),c=Math.PI/2,l={channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete"},u={...l,oversample:"none"},h=(_,g,p,f)=>{const y=new Float32Array(16385),x=new Float32Array(16385);for(let S=0;S<16385;S+=1){const v=S/16384*c;y[S]=Math.cos(v),x[S]=Math.sin(v)}const T=e(_,{...l,gain:0}),w=n(_,{...u,curve:y}),E=n(_,{...u,curve:a}),b=e(_,{...l,gain:0}),C=n(_,{...u,curve:x});return{connectGraph(){g.connect(T),g.connect(E.inputs===void 0?E:E.inputs[0]),g.connect(b),E.connect(p),p.connect(w.inputs===void 0?w:w.inputs[0]),p.connect(C.inputs===void 0?C:C.inputs[0]),w.connect(T.gain),C.connect(b.gain),T.connect(f,0,0),b.connect(f,0,1)},disconnectGraph(){g.disconnect(T),g.disconnect(E.inputs===void 0?E:E.inputs[0]),g.disconnect(b),E.disconnect(p),p.disconnect(w.inputs===void 0?w:w.inputs[0]),p.disconnect(C.inputs===void 0?C:C.inputs[0]),w.disconnect(T.gain),C.disconnect(b.gain),T.disconnect(f,0,0),b.disconnect(f,0,1)}}},d=(_,g,p,f)=>{const y=new Float32Array(16385),x=new Float32Array(16385),T=new Float32Array(16385),w=new Float32Array(16385),E=Math.floor(16385/2);for(let B=0;B<16385;B+=1)if(B>E){const V=(B-E)/(16384-E)*c;y[B]=Math.cos(V),x[B]=Math.sin(V),T[B]=0,w[B]=1}else{const V=B/(16384-E)*c;y[B]=1,x[B]=0,T[B]=Math.cos(V),w[B]=Math.sin(V)}const b=t(_,{channelCount:2,channelCountMode:"explicit",channelInterpretation:"discrete",numberOfOutputs:2}),C=e(_,{...l,gain:0}),S=n(_,{...u,curve:y}),v=e(_,{...l,gain:0}),R=n(_,{...u,curve:x}),P=n(_,{...u,curve:a}),N=e(_,{...l,gain:0}),F=n(_,{...u,curve:T}),z=e(_,{...l,gain:0}),U=n(_,{...u,curve:w});return{connectGraph(){g.connect(b),g.connect(P.inputs===void 0?P:P.inputs[0]),b.connect(C,0),b.connect(v,0),b.connect(N,1),b.connect(z,1),P.connect(p),p.connect(S.inputs===void 0?S:S.inputs[0]),p.connect(R.inputs===void 0?R:R.inputs[0]),p.connect(F.inputs===void 0?F:F.inputs[0]),p.connect(U.inputs===void 0?U:U.inputs[0]),S.connect(C.gain),R.connect(v.gain),F.connect(N.gain),U.connect(z.gain),C.connect(f,0,0),N.connect(f,0,0),v.connect(f,0,1),z.connect(f,0,1)},disconnectGraph(){g.disconnect(b),g.disconnect(P.inputs===void 0?P:P.inputs[0]),b.disconnect(C,0),b.disconnect(v,0),b.disconnect(N,1),b.disconnect(z,1),P.disconnect(p),p.disconnect(S.inputs===void 0?S:S.inputs[0]),p.disconnect(R.inputs===void 0?R:R.inputs[0]),p.disconnect(F.inputs===void 0?F:F.inputs[0]),p.disconnect(U.inputs===void 0?U:U.inputs[0]),S.disconnect(C.gain),R.disconnect(v.gain),F.disconnect(N.gain),U.disconnect(z.gain),C.disconnect(f,0,0),N.disconnect(f,0,0),v.disconnect(f,0,1),z.disconnect(f,0,1)}}},m=(_,g,p,f,y)=>{if(g===1)return h(_,p,f,y);if(g===2)return d(_,p,f,y);throw s()};return(_,{channelCount:g,channelCountMode:p,pan:f,...y})=>{if(p==="max")throw s();const x=i(_,{...y,channelCount:1,channelCountMode:p,numberOfInputs:2}),T=e(_,{...y,channelCount:g,channelCountMode:p,gain:1}),w=e(_,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",gain:f});let{connectGraph:E,disconnectGraph:b}=m(_,g,T,w,x);Object.defineProperty(w.gain,"defaultValue",{get:()=>0}),Object.defineProperty(w.gain,"maxValue",{get:()=>1}),Object.defineProperty(w.gain,"minValue",{get:()=>-1});const C={get bufferSize(){},get channelCount(){return T.channelCount},set channelCount(P){T.channelCount!==P&&(S&&b(),{connectGraph:E,disconnectGraph:b}=m(_,P,T,w,x),S&&E()),T.channelCount=P},get channelCountMode(){return T.channelCountMode},set channelCountMode(P){if(P==="clamped-max"||P==="max")throw s();T.channelCountMode=P},get channelInterpretation(){return T.channelInterpretation},set channelInterpretation(P){T.channelInterpretation=P},get context(){return T.context},get inputs(){return[T]},get numberOfInputs(){return T.numberOfInputs},get numberOfOutputs(){return T.numberOfOutputs},get pan(){return w.gain},addEventListener(...P){return T.addEventListener(P[0],P[1],P[2])},dispatchEvent(...P){return T.dispatchEvent(P[0])},removeEventListener(...P){return T.removeEventListener(P[0],P[1],P[2])}};let S=!1;const v=()=>{E(),S=!0},R=()=>{b(),S=!1};return r(Zs(C,x),v,R)}},G_=(i,t,e,n,s,r,o)=>(a,c)=>{const l=a.createWaveShaper();if(r!==null&&r.name==="webkitAudioContext"&&a.createGain().gain.automationRate===void 0)return e(a,c);Te(l,c);const u=c.curve===null||c.curve instanceof Float32Array?c.curve:new Float32Array(c.curve);if(u!==null&&u.length<2)throw t();le(l,{curve:u},"curve"),le(l,c,"oversample");let h=null,d=!1;return o(l,"curve",g=>()=>g.call(l),g=>p=>(g.call(l,p),d&&(n(p)&&h===null?h=i(a,l):!n(p)&&h!==null&&(h(),h=null)),p)),s(l,()=>{d=!0,n(l.curve)&&(h=i(a,l))},()=>{d=!1,h!==null&&(h(),h=null)})},H_=(i,t,e,n,s)=>(r,{curve:o,oversample:a,...c})=>{const l=r.createWaveShaper(),u=r.createWaveShaper();Te(l,c),Te(u,c);const h=e(r,{...c,gain:1}),d=e(r,{...c,gain:-1}),m=e(r,{...c,gain:1}),_=e(r,{...c,gain:-1});let g=null,p=!1,f=null;const y={get bufferSize(){},get channelCount(){return l.channelCount},set channelCount(w){h.channelCount=w,d.channelCount=w,l.channelCount=w,m.channelCount=w,u.channelCount=w,_.channelCount=w},get channelCountMode(){return l.channelCountMode},set channelCountMode(w){h.channelCountMode=w,d.channelCountMode=w,l.channelCountMode=w,m.channelCountMode=w,u.channelCountMode=w,_.channelCountMode=w},get channelInterpretation(){return l.channelInterpretation},set channelInterpretation(w){h.channelInterpretation=w,d.channelInterpretation=w,l.channelInterpretation=w,m.channelInterpretation=w,u.channelInterpretation=w,_.channelInterpretation=w},get context(){return l.context},get curve(){return f},set curve(w){if(w!==null&&w.length<2)throw t();if(w===null)l.curve=w,u.curve=w;else{const E=w.length,b=new Float32Array(E+2-E%2),C=new Float32Array(E+2-E%2);b[0]=w[0],C[0]=-w[E-1];const S=Math.ceil((E+1)/2),v=(E+1)/2-1;for(let R=1;R<S;R+=1){const P=R/S*v,N=Math.floor(P),F=Math.ceil(P);b[R]=N===F?w[N]:(1-(P-N))*w[N]+(1-(F-P))*w[F],C[R]=N===F?-w[E-1-N]:-((1-(P-N))*w[E-1-N])-(1-(F-P))*w[E-1-F]}b[S]=E%2===1?w[S-1]:(w[S-2]+w[S-1])/2,l.curve=b,u.curve=C}f=w,p&&(n(f)&&g===null?g=i(r,h):g!==null&&(g(),g=null))},get inputs(){return[h]},get numberOfInputs(){return l.numberOfInputs},get numberOfOutputs(){return l.numberOfOutputs},get oversample(){return l.oversample},set oversample(w){l.oversample=w,u.oversample=w},addEventListener(...w){return h.addEventListener(w[0],w[1],w[2])},dispatchEvent(...w){return h.dispatchEvent(w[0])},removeEventListener(...w){return h.removeEventListener(w[0],w[1],w[2])}};o!==null&&(y.curve=o instanceof Float32Array?o:new Float32Array(o)),a!==y.oversample&&(y.oversample=a);const x=()=>{h.connect(l).connect(m),h.connect(d).connect(u).connect(_).connect(m),p=!0,n(f)&&(g=i(r,h))},T=()=>{h.disconnect(l),l.disconnect(m),h.disconnect(d),d.disconnect(u),u.disconnect(_),_.disconnect(m),p=!1,g!==null&&(g(),g=null)};return s(Zs(y,m),x,T)},ze=()=>new DOMException("","NotSupportedError"),W_={numberOfChannels:1},q_=(i,t,e,n,s)=>class extends i{constructor(o,a,c){let l;if(typeof o=="number"&&a!==void 0&&c!==void 0)l={length:a,numberOfChannels:o,sampleRate:c};else if(typeof o=="object")l=o;else throw new Error("The given parameters are not valid.");const{length:u,numberOfChannels:h,sampleRate:d}={...W_,...l},m=n(h,u,d);t(mr,()=>mr(m))||m.addEventListener("statechange",(()=>{let _=0;const g=p=>{this._state==="running"&&(_>0?(m.removeEventListener("statechange",g),p.stopImmediatePropagation(),this._waitForThePromiseToSettle(p)):_+=1)};return g})()),super(m,h),this._length=u,this._nativeOfflineAudioContext=m,this._state=null}get length(){return this._nativeOfflineAudioContext.length===void 0?this._length:this._nativeOfflineAudioContext.length}get state(){return this._state===null?this._nativeOfflineAudioContext.state:this._state}startRendering(){return this._state==="running"?Promise.reject(e()):(this._state="running",s(this.destination,this._nativeOfflineAudioContext).finally(()=>{this._state=null,Wh(this)}))}_waitForThePromiseToSettle(o){this._state===null?this._nativeOfflineAudioContext.dispatchEvent(o):setTimeout(()=>this._waitForThePromiseToSettle(o))}},X_={channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",detune:0,frequency:440,periodicWave:void 0,type:"sine"},Y_=(i,t,e,n,s,r,o)=>class extends i{constructor(c,l){const u=s(c),h={...X_,...l},d=e(u,h),m=r(u),_=m?n():null,g=c.sampleRate/2;super(c,!1,d,_),this._detune=t(this,m,d.detune,153600,-153600),this._frequency=t(this,m,d.frequency,g,-g),this._nativeOscillatorNode=d,this._onended=null,this._oscillatorNodeRenderer=_,this._oscillatorNodeRenderer!==null&&h.periodicWave!==void 0&&(this._oscillatorNodeRenderer.periodicWave=h.periodicWave)}get detune(){return this._detune}get frequency(){return this._frequency}get onended(){return this._onended}set onended(c){const l=typeof c=="function"?o(this,c):null;this._nativeOscillatorNode.onended=l;const u=this._nativeOscillatorNode.onended;this._onended=u!==null&&u===l?c:u}get type(){return this._nativeOscillatorNode.type}set type(c){this._nativeOscillatorNode.type=c,this._oscillatorNodeRenderer!==null&&(this._oscillatorNodeRenderer.periodicWave=null)}setPeriodicWave(c){this._nativeOscillatorNode.setPeriodicWave(c),this._oscillatorNodeRenderer!==null&&(this._oscillatorNodeRenderer.periodicWave=c)}start(c=0){if(this._nativeOscillatorNode.start(c),this._oscillatorNodeRenderer!==null&&(this._oscillatorNodeRenderer.start=c),this.context.state!=="closed"){Os(this);const l=()=>{this._nativeOscillatorNode.removeEventListener("ended",l),Jn(this)&&Nr(this)};this._nativeOscillatorNode.addEventListener("ended",l)}}stop(c=0){this._nativeOscillatorNode.stop(c),this._oscillatorNodeRenderer!==null&&(this._oscillatorNodeRenderer.stop=c)}},j_=(i,t,e,n,s)=>()=>{const r=new WeakMap;let o=null,a=null,c=null;const l=async(u,h)=>{let d=e(u);const m=Ue(d,h);if(!m){const _={channelCount:d.channelCount,channelCountMode:d.channelCountMode,channelInterpretation:d.channelInterpretation,detune:d.detune.value,frequency:d.frequency.value,periodicWave:o===null?void 0:o,type:d.type};d=t(h,_),a!==null&&d.start(a),c!==null&&d.stop(c)}return r.set(h,d),m?(await i(h,u.detune,d.detune),await i(h,u.frequency,d.frequency)):(await n(h,u.detune,d.detune),await n(h,u.frequency,d.frequency)),await s(u,h,d),d};return{set periodicWave(u){o=u},set start(u){a=u},set stop(u){c=u},render(u,h){const d=r.get(h);return d!==void 0?Promise.resolve(d):l(u,h)}}},$_={channelCount:2,channelCountMode:"clamped-max",channelInterpretation:"speakers",coneInnerAngle:360,coneOuterAngle:360,coneOuterGain:0,distanceModel:"inverse",maxDistance:1e4,orientationX:1,orientationY:0,orientationZ:0,panningModel:"equalpower",positionX:0,positionY:0,positionZ:0,refDistance:1,rolloffFactor:1},Z_=(i,t,e,n,s,r,o)=>class extends i{constructor(c,l){const u=s(c),h={...$_,...l},d=e(u,h),m=r(u),_=m?n():null;super(c,!1,d,_),this._nativePannerNode=d,this._orientationX=t(this,m,d.orientationX,ke,He),this._orientationY=t(this,m,d.orientationY,ke,He),this._orientationZ=t(this,m,d.orientationZ,ke,He),this._positionX=t(this,m,d.positionX,ke,He),this._positionY=t(this,m,d.positionY,ke,He),this._positionZ=t(this,m,d.positionZ,ke,He),o(this,1)}get coneInnerAngle(){return this._nativePannerNode.coneInnerAngle}set coneInnerAngle(c){this._nativePannerNode.coneInnerAngle=c}get coneOuterAngle(){return this._nativePannerNode.coneOuterAngle}set coneOuterAngle(c){this._nativePannerNode.coneOuterAngle=c}get coneOuterGain(){return this._nativePannerNode.coneOuterGain}set coneOuterGain(c){this._nativePannerNode.coneOuterGain=c}get distanceModel(){return this._nativePannerNode.distanceModel}set distanceModel(c){this._nativePannerNode.distanceModel=c}get maxDistance(){return this._nativePannerNode.maxDistance}set maxDistance(c){this._nativePannerNode.maxDistance=c}get orientationX(){return this._orientationX}get orientationY(){return this._orientationY}get orientationZ(){return this._orientationZ}get panningModel(){return this._nativePannerNode.panningModel}set panningModel(c){this._nativePannerNode.panningModel=c}get positionX(){return this._positionX}get positionY(){return this._positionY}get positionZ(){return this._positionZ}get refDistance(){return this._nativePannerNode.refDistance}set refDistance(c){this._nativePannerNode.refDistance=c}get rolloffFactor(){return this._nativePannerNode.rolloffFactor}set rolloffFactor(c){this._nativePannerNode.rolloffFactor=c}},K_=(i,t,e,n,s,r,o,a,c,l)=>()=>{const u=new WeakMap;let h=null;const d=async(m,_)=>{let g=null,p=r(m);const f={channelCount:p.channelCount,channelCountMode:p.channelCountMode,channelInterpretation:p.channelInterpretation},y={...f,coneInnerAngle:p.coneInnerAngle,coneOuterAngle:p.coneOuterAngle,coneOuterGain:p.coneOuterGain,distanceModel:p.distanceModel,maxDistance:p.maxDistance,panningModel:p.panningModel,refDistance:p.refDistance,rolloffFactor:p.rolloffFactor},x=Ue(p,_);if("bufferSize"in p)g=n(_,{...f,gain:1});else if(!x){const T={...y,orientationX:p.orientationX.value,orientationY:p.orientationY.value,orientationZ:p.orientationZ.value,positionX:p.positionX.value,positionY:p.positionY.value,positionZ:p.positionZ.value};p=s(_,T)}if(u.set(_,g===null?p:g),g!==null){if(h===null){if(o===null)throw new Error("Missing the native OfflineAudioContext constructor.");const R=new o(6,m.context.length,_.sampleRate),P=t(R,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"speakers",numberOfInputs:6});P.connect(R.destination),h=(async()=>{const N=await Promise.all([m.orientationX,m.orientationY,m.orientationZ,m.positionX,m.positionY,m.positionZ].map(async(F,z)=>{const U=e(R,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",offset:z===0?1:0});return await a(R,F,U.offset),U}));for(let F=0;F<6;F+=1)N[F].connect(P,0,F),N[F].start(0);return l(R)})()}const T=await h,w=n(_,{...f,gain:1});await c(m,_,w);const E=[];for(let R=0;R<T.numberOfChannels;R+=1)E.push(T.getChannelData(R));let b=[E[0][0],E[1][0],E[2][0]],C=[E[3][0],E[4][0],E[5][0]],S=n(_,{...f,gain:1}),v=s(_,{...y,orientationX:b[0],orientationY:b[1],orientationZ:b[2],positionX:C[0],positionY:C[1],positionZ:C[2]});w.connect(S).connect(v.inputs[0]),v.connect(g);for(let R=128;R<T.length;R+=128){const P=[E[0][R],E[1][R],E[2][R]],N=[E[3][R],E[4][R],E[5][R]];if(P.some((F,z)=>F!==b[z])||N.some((F,z)=>F!==C[z])){b=P,C=N;const F=R/_.sampleRate;S.gain.setValueAtTime(0,F),S=n(_,{...f,gain:0}),v=s(_,{...y,orientationX:b[0],orientationY:b[1],orientationZ:b[2],positionX:C[0],positionY:C[1],positionZ:C[2]}),S.gain.setValueAtTime(1,F),w.connect(S).connect(v.inputs[0]),v.connect(g)}}return g}return x?(await i(_,m.orientationX,p.orientationX),await i(_,m.orientationY,p.orientationY),await i(_,m.orientationZ,p.orientationZ),await i(_,m.positionX,p.positionX),await i(_,m.positionY,p.positionY),await i(_,m.positionZ,p.positionZ)):(await a(_,m.orientationX,p.orientationX),await a(_,m.orientationY,p.orientationY),await a(_,m.orientationZ,p.orientationZ),await a(_,m.positionX,p.positionX),await a(_,m.positionY,p.positionY),await a(_,m.positionZ,p.positionZ)),$s(p)?await c(m,_,p.inputs[0]):await c(m,_,p),p};return{render(m,_){const g=u.get(_);return g!==void 0?Promise.resolve(g):d(m,_)}}},J_={disableNormalization:!1},Q_=(i,t,e,n)=>class td{constructor(r,o){const a=t(r),c=n({...J_,...o}),l=i(a,c);return e.add(l),l}static[Symbol.hasInstance](r){return r!==null&&typeof r=="object"&&Object.getPrototypeOf(r)===td.prototype||e.has(r)}},tg=(i,t)=>(e,n,s)=>(i(n).replay(s),t(n,e,s)),eg=(i,t,e)=>async(n,s,r)=>{const o=i(n);await Promise.all(o.activeInputs.map((a,c)=>Array.from(a).map(async([l,u])=>{const d=await t(l).render(l,s),m=n.context.destination;!e(l)&&(n!==m||!e(n))&&d.connect(r,u,c)})).reduce((a,c)=>[...a,...c],[]))},ng=(i,t,e)=>async(n,s,r)=>{const o=t(n);await Promise.all(Array.from(o.activeInputs).map(async([a,c])=>{const u=await i(a).render(a,s);e(a)||u.connect(r,c)}))},ig=(i,t,e,n)=>s=>i(mr,()=>mr(s))?Promise.resolve(i(n,n)).then(r=>{if(!r){const o=e(s,512,0,1);s.oncomplete=()=>{o.onaudioprocess=null,o.disconnect()},o.onaudioprocess=()=>s.currentTime,o.connect(s.destination)}return s.startRendering()}):new Promise(r=>{const o=t(s,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",gain:0});s.oncomplete=a=>{o.disconnect(),r(a.renderedBuffer)},o.connect(s.destination),s.startRendering()}),sg=i=>(t,e)=>{i.set(t,e)},rg=i=>(t,e)=>i.set(t,e),og=(i,t,e,n,s,r,o,a)=>(c,l)=>e(c).render(c,l).then(()=>Promise.all(Array.from(n(l)).map(u=>e(u).render(u,l)))).then(()=>s(l)).then(u=>(typeof u.copyFromChannel!="function"?(o(u),gl(u)):t(r,()=>r(u))||a(u),i.add(u),u)),ag={channelCount:2,channelCountMode:"explicit",channelInterpretation:"speakers",pan:0},cg=(i,t,e,n,s,r)=>class extends i{constructor(a,c){const l=s(a),u={...ag,...c},h=e(l,u),d=r(l),m=d?n():null;super(a,!1,h,m),this._pan=t(this,d,h.pan)}get pan(){return this._pan}},lg=(i,t,e,n,s)=>()=>{const r=new WeakMap,o=async(a,c)=>{let l=e(a);const u=Ue(l,c);if(!u){const h={channelCount:l.channelCount,channelCountMode:l.channelCountMode,channelInterpretation:l.channelInterpretation,pan:l.pan.value};l=t(c,h)}return r.set(c,l),u?await i(c,a.pan,l.pan):await n(c,a.pan,l.pan),$s(l)?await s(a,c,l.inputs[0]):await s(a,c,l),l};return{render(a,c){const l=r.get(c);return l!==void 0?Promise.resolve(l):o(a,c)}}},ug=i=>()=>{if(i===null)return!1;try{new i({length:1,sampleRate:44100})}catch{return!1}return!0},hg=(i,t)=>async()=>{if(i===null)return!0;if(t===null)return!1;const e=new Blob(['class A extends AudioWorkletProcessor{process(i){this.port.postMessage(i,[i[0][0].buffer])}}registerProcessor("a",A)'],{type:"application/javascript; charset=utf-8"}),n=new t(1,128,44100),s=URL.createObjectURL(e);let r=!1,o=!1;try{await n.audioWorklet.addModule(s);const a=new i(n,"a",{numberOfOutputs:0}),c=n.createOscillator();a.port.onmessage=()=>r=!0,a.onprocessorerror=()=>o=!0,c.connect(a),c.start(0),await n.startRendering(),await new Promise(l=>setTimeout(l))}catch{}finally{URL.revokeObjectURL(s)}return r&&!o},dg=(i,t)=>()=>{if(t===null)return Promise.resolve(!1);const e=new t(1,1,44100),n=i(e,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",gain:0});return new Promise(s=>{e.oncomplete=()=>{n.disconnect(),s(e.currentTime!==0)},e.startRendering()})},fg=()=>new DOMException("","UnknownError"),pg={channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",curve:null,oversample:"none"},mg=(i,t,e,n,s,r,o)=>class extends i{constructor(c,l){const u=s(c),h={...pg,...l},d=e(u,h),_=r(u)?n():null;super(c,!0,d,_),this._isCurveNullified=!1,this._nativeWaveShaperNode=d,o(this,1)}get curve(){return this._isCurveNullified?null:this._nativeWaveShaperNode.curve}set curve(c){if(c===null)this._isCurveNullified=!0,this._nativeWaveShaperNode.curve=new Float32Array([0,0]);else{if(c.length<2)throw t();this._isCurveNullified=!1,this._nativeWaveShaperNode.curve=c}}get oversample(){return this._nativeWaveShaperNode.oversample}set oversample(c){this._nativeWaveShaperNode.oversample=c}},_g=(i,t,e)=>()=>{const n=new WeakMap,s=async(r,o)=>{let a=t(r);if(!Ue(a,o)){const l={channelCount:a.channelCount,channelCountMode:a.channelCountMode,channelInterpretation:a.channelInterpretation,curve:a.curve,oversample:a.oversample};a=i(o,l)}return n.set(o,a),$s(a)?await e(r,o,a.inputs[0]):await e(r,o,a),a};return{render(r,o){const a=n.get(o);return a!==void 0?Promise.resolve(a):s(r,o)}}},gg=()=>typeof window>"u"?null:window,vg=(i,t)=>e=>{e.copyFromChannel=(n,s,r=0)=>{const o=i(r),a=i(s);if(a>=e.numberOfChannels)throw t();const c=e.length,l=e.getChannelData(a),u=n.length;for(let h=o<0?-o:0;h+o<c&&h<u;h+=1)n[h]=l[h+o]},e.copyToChannel=(n,s,r=0)=>{const o=i(r),a=i(s);if(a>=e.numberOfChannels)throw t();const c=e.length,l=e.getChannelData(a),u=n.length;for(let h=o<0?-o:0;h+o<c&&h<u;h+=1)l[h+o]=n[h]}},xg=i=>t=>{t.copyFromChannel=(e=>(n,s,r=0)=>{const o=i(r),a=i(s);if(o<t.length)return e.call(t,n,a,o)})(t.copyFromChannel),t.copyToChannel=(e=>(n,s,r=0)=>{const o=i(r),a=i(s);if(o<t.length)return e.call(t,n,a,o)})(t.copyToChannel)},yg=i=>(t,e)=>{const n=e.createBuffer(1,1,44100);t.buffer===null&&(t.buffer=n),i(t,"buffer",s=>()=>{const r=s.call(t);return r===n?null:r},s=>r=>s.call(t,r===null?n:r))},Sg=(i,t)=>(e,n)=>{n.channelCount=1,n.channelCountMode="explicit",Object.defineProperty(n,"channelCount",{get:()=>1,set:()=>{throw i()}}),Object.defineProperty(n,"channelCountMode",{get:()=>"explicit",set:()=>{throw i()}});const s=e.createBufferSource();t(n,()=>{const a=n.numberOfInputs;for(let c=0;c<a;c+=1)s.connect(n,0,c)},()=>s.disconnect(n))},ed=(i,t,e)=>i.copyFromChannel===void 0?i.getChannelData(e)[0]:(i.copyFromChannel(t,e),t[0]),nd=i=>{if(i===null)return!1;const t=i.length;return t%2!==0?i[Math.floor(t/2)]!==0:i[t/2-1]+i[t/2]!==0},kr=(i,t,e,n)=>{let s=i;for(;!s.hasOwnProperty(t);)s=Object.getPrototypeOf(s);const{get:r,set:o}=Object.getOwnPropertyDescriptor(s,t);Object.defineProperty(i,t,{get:e(r),set:n(o)})},Mg=i=>({...i,outputChannelCount:i.outputChannelCount!==void 0?i.outputChannelCount:i.numberOfInputs===1&&i.numberOfOutputs===1?[i.channelCount]:Array.from({length:i.numberOfOutputs},()=>1)}),Tg=i=>({...i,channelCount:i.numberOfOutputs}),Eg=i=>{const{imag:t,real:e}=i;return t===void 0?e===void 0?{...i,imag:[0,0],real:[0,0]}:{...i,imag:Array.from(e,()=>0),real:e}:e===void 0?{...i,imag:t,real:Array.from(t,()=>0)}:{...i,imag:t,real:e}},id=(i,t,e)=>{try{i.setValueAtTime(t,e)}catch(n){if(n.code!==9)throw n;id(i,t,e+1e-7)}},bg=i=>{const t=i.createBufferSource();t.start();try{t.start()}catch{return!0}return!1},wg=i=>{const t=i.createBufferSource(),e=i.createBuffer(1,1,44100);t.buffer=e;try{t.start(0,1)}catch{return!1}return!0},Ag=i=>{const t=i.createBufferSource();t.start();try{t.stop()}catch{return!1}return!0},Ml=i=>{const t=i.createOscillator();try{t.start(-1)}catch(e){return e instanceof RangeError}return!1},sd=i=>{const t=i.createBuffer(1,1,44100),e=i.createBufferSource();e.buffer=t,e.start(),e.stop();try{return e.stop(),!0}catch{return!1}},Tl=i=>{const t=i.createOscillator();try{t.stop(-1)}catch(e){return e instanceof RangeError}return!1},Cg=i=>{const{port1:t,port2:e}=new MessageChannel;try{t.postMessage(i)}finally{t.close(),e.close()}},Rg=i=>{i.start=(t=>(e=0,n=0,s)=>{const r=i.buffer,o=r===null?n:Math.min(r.duration,n);r!==null&&o>r.duration-.5/i.context.sampleRate?t.call(i,e,0,0):t.call(i,e,o,s)})(i.start)},rd=(i,t)=>{const e=t.createGain();i.connect(e);const n=(s=>()=>{s.call(i,e),i.removeEventListener("ended",n)})(i.disconnect);i.addEventListener("ended",n),Zs(i,e),i.stop=(s=>{let r=!1;return(o=0)=>{if(r)try{s.call(i,o)}catch{e.gain.setValueAtTime(0,o)}else s.call(i,o),r=!0}})(i.stop)},Ks=(i,t)=>e=>{const n={value:i};return Object.defineProperties(e,{currentTarget:n,target:n}),typeof t=="function"?t.call(i,e):t.handleEvent.call(i,e)},Dg=Zf(is),Pg=np(is),Ig=pm(Ma),od=new WeakMap,Ng=Im(od),En=Wp(new Map,new WeakMap),In=gg(),ad=c_(En,Un),El=Pm(Be),Ie=eg(Be,El,Yi),Lg=ap(ad,ce,Ie),oe=Om(Sa),ni=O_(In),re=Jm(ni),cd=new WeakMap,ld=Em(Ks),Br=d_(In),bl=jm(Br),wl=$m(In),ud=Zm(In),_r=p_(In),ve=Ip(Kf(Fh),ep(Dg,Pg,Vo,Ig,zo,Be,Ng,Ir,ce,is,Jn,Yi,Eo),En,Hm(wc,zo,Be,ce,pr,Jn),Un,Ta,ze,um(Vo,wc,Be,ce,pr,oe,Jn,re),gm(cd,Be,xn),ld,oe,bl,wl,ud,re,_r),Og=op(ve,Lg,Un,ad,oe,re),Al=new WeakSet,bu=l_(In),hd=im(new Uint32Array(1)),Cl=vg(hd,Un),Rl=xg(hd),dd=lp(Al,En,ze,bu,ni,ug(bu),Cl,Rl),Ea=ip(Ye),fd=ng(El,Lr,Yi),Fn=Kp(fd),Js=h_(Ea,En,bg,wg,Ag,Ml,sd,Tl,Rg,yg(kr),rd),kn=tg(Nm(Lr),fd),Ug=dp(Fn,Js,ce,kn,Ie),bn=Np(Jf(kh),cd,_l,Lp,Wf,qf,Xf,Yf,jf,Tc,Oh,Br,id),Fg=hp(ve,Ug,bn,Ce,Js,oe,re,Ks),kg=Sp(ve,Mp,Un,Ce,f_(Ye,kr),oe,re,Ie),Bg=Hp(Fn,Jh,ce,kn,Ie),ss=rg(od),Vg=Gp(ve,bn,Bg,Ta,Jh,oe,re,ss),Ti=o_(is,wl),zg=Sg(Ce,Ti),Ei=S_(Br,zg),Gg=Yp(Ei,ce,Ie),Hg=Xp(ve,Gg,Ei,oe,re),Wg=Zp(Ur,ce,Ie),qg=$p(ve,Wg,Ur,oe,re,Tg),Xg=E_(Ea,Js,Ye,Ti),Qs=T_(Ea,En,Xg,Ml,Tl),Yg=nm(Fn,Qs,ce,kn,Ie),jg=em(ve,bn,Yg,Qs,oe,re,Ks),pd=b_(ze,kr),$g=om(pd,ce,Ie),Zg=rm(ve,$g,pd,oe,re,ss),Kg=fm(Fn,Qh,ce,kn,Ie),Jg=dm(ve,bn,Kg,Qh,oe,re,ss),md=w_(ze),Qg=Sm(Fn,md,ce,kn,Ie),tv=ym(ve,bn,Qg,md,ze,oe,re,ss),ev=Rm(Fn,Ye,ce,kn,Ie),nv=Cm(ve,bn,ev,Ye,oe,re),iv=D_(Ta,Ce,Fr,ze),ba=ig(En,Ye,Fr,dg(Ye,ni)),sv=Gm(Js,ce,ni,Ie,ba),rv=A_(iv),ov=Vm(ve,rv,sv,oe,re,ss),av=Tp(bn,Ei,Qs,Fr,ze,ed,re,kr),_d=new WeakMap,cv=r_(kg,av,ld,re,_d,Ks),gd=U_(Ea,En,Ml,sd,Tl,rd),lv=j_(Fn,gd,ce,kn,Ie),uv=Y_(ve,bn,gd,lv,oe,re,Ks),vd=Qp(Js),hv=H_(vd,Ce,Ye,nd,Ti),wa=G_(vd,Ce,hv,nd,Ti,Br,kr),dv=k_(Vo,Ce,Ei,Ye,Fr,wa,ze,zo,ed,Ti),xd=F_(dv),fv=K_(Fn,Ei,Qs,Ye,xd,ce,ni,kn,Ie,ba),pv=Z_(ve,bn,xd,fv,oe,re,ss),mv=B_(Un),_v=Q_(mv,oe,new WeakSet,Eg),gv=z_(Ei,Ur,Ye,wa,ze,Ti),yd=V_(gv,ze),vv=lg(Fn,yd,ce,kn,Ie),xv=cg(ve,bn,yd,vv,oe,re),yv=_g(wa,ce,Ie),Sv=mg(ve,Ce,wa,yv,oe,re,ss),Sd=Qm(In),Dl=bm(In),Md=new WeakMap,Mv=Um(Md,ni),Tv=Sd?tp(En,ze,Tm(In),Dl,wm($f),oe,Mv,re,_r,new WeakMap,new WeakMap,hg(_r,ni),In):void 0,Ev=Km(bl,re),bv=lm(Al,En,cm,Mm,new WeakSet,oe,Ev,ko,mr,Cl,Rl),Td=Vp(Tv,Og,dd,Fg,Vg,Hg,qg,jg,Zg,bv,Jg,tv,nv,ov,cv,uv,pv,_v,xv,Sv),wv=t_(ve,P_,oe,re),Av=n_(ve,I_,oe,re),Cv=i_(ve,N_,oe,re),Rv=L_(Ce,re),Dv=s_(ve,Rv,oe),Pv=yp(Td,Ce,ze,fg,wv,Av,Cv,Dv,Br),Pl=Fm(_d),Iv=sp(Pl),Ed=Jp(Un),Nv=mm(Pl),bd=vm(Un),wd=new WeakMap,Lv=Dm(wd,xn),Ov=y_(Ed,Un,Ce,Ei,Ur,Qs,Ye,Fr,ze,bd,Dl,Lv,Ti),Uv=__(Ce,Ov,Ye,ze,Ti),Fv=Bp(Fn,Ed,Js,Ei,Ur,Qs,Ye,Nv,bd,Dl,ce,_r,ni,kn,Ie,ba),kv=Lm(Md),Bv=sg(wd),wu=Sd?Up(Iv,ve,bn,Fv,Uv,Be,kv,oe,re,_r,Mg,Bv,Cg,Ks):void 0,Vv=am(ze,ni),zv=og(Al,En,El,Pl,ba,ko,Cl,Rl),Gv=q_(Td,En,Ce,Vv,zv),Hv=Wm(Sa,bl),Wv=qm(ml,wl),qv=Xm(_l,ud),Xv=Ym(Sa,re);function on(i){return i===void 0}function zt(i){return i!==void 0}function Yv(i){return typeof i=="function"}function yn(i){return typeof i=="number"}function Hi(i){return Object.prototype.toString.call(i)==="[object Object]"&&i.constructor===Object}function Ad(i){return typeof i=="boolean"}function Qe(i){return Array.isArray(i)}function Qn(i){return typeof i=="string"}function Kr(i){return Qn(i)&&/^([a-g]{1}(?:b|#|x|bb)?)(-?[0-9]+)/i.test(i)}function At(i,t){if(!i)throw new Error(t)}function Sn(i,t,e=1/0){if(!(t<=i&&i<=e))throw new RangeError(`Value must be within [${t}, ${e}], got: ${i}`)}function Cd(i){!i.isOffline&&i.state!=="running"&&Aa('The AudioContext is "suspended". Invoke Tone.start() from a user action to start the audio.')}let Rd=!1,Au=!1;function Cu(i){Rd=i}function jv(i){on(i)&&Rd&&!Au&&(Au=!0,Aa("Events scheduled inside of scheduled callbacks should use the passed in scheduling time. See https://github.com/Tonejs/Tone.js/wiki/Accurate-Timing"))}let Dd=console;function $v(...i){Dd.log(...i)}function Aa(...i){Dd.warn(...i)}function Zv(i){return new Pv(i)}function Kv(i,t,e){return new Gv(i,t,e)}const Wi=typeof self=="object"?self:null,Jv=Wi&&(Wi.hasOwnProperty("AudioContext")||Wi.hasOwnProperty("webkitAudioContext"));function Qv(i,t,e){return At(zt(wu),"This node only works in a secure context (https or localhost)"),new wu(i,t,e)}function wn(i,t,e,n){var s=arguments.length,r=s<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,e):n,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,t,e,n);else for(var a=i.length-1;a>=0;a--)(o=i[a])&&(r=(s<3?o(r):s>3?o(t,e,r):o(t,e))||r);return s>3&&r&&Object.defineProperty(t,e,r),r}function ge(i,t,e,n){function s(r){return r instanceof e?r:new e(function(o){o(r)})}return new(e||(e=Promise))(function(r,o){function a(u){try{l(n.next(u))}catch(h){o(h)}}function c(u){try{l(n.throw(u))}catch(h){o(h)}}function l(u){u.done?r(u.value):s(u.value).then(a,c)}l((n=n.apply(i,t||[])).next())})}class t0{constructor(t,e,n,s){this._callback=t,this._type=e,this._minimumUpdateInterval=Math.max(128/(s||44100),.001),this.updateInterval=n,this._createClock()}_createWorker(){const t=new Blob([`
...
`;Bl(T0);const E0="feedback-comb-filter",b0=`
...
#endif`,Ly="gl_FragColor = linearToOutputTexel( gl_FragColor );",Oy=`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:_i,depthTest:!1,depthWrite:!1})}function fh(){return new Mi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:jl(),fragmentShader:`
		...
		`,blending:_i,depthTest:!1,depthWrite:!1})}function ph(){return new Mi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:jl(),fragmentShader:`
	...
	`}function YM(i){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const c=a.mapping,l=c===Lc||c===Oc,u=c===Ws||c===qs;if(l||u){let h=t.get(a);const d=h!==void 0?h.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return e===null&&(e=new hh(i)),h=l?e.fromEquirectangular(a,h):e.fromCubemap(a,h),h.texture.pmremVersion=a.pmremVersion,t.set(a,h),h.texture;if(h!==void 0)return h.texture;{const m=a.image;return l&&m&&m.height>0||u&&m&&s(m)?(e===null&&(e=new hh(i)),h=l?e.fromEquirectangular(a):e.fromCubemap(a),h.texture.pmremVersion=a.pmremVersion,t.set(a,h),a.addEventListener("dispose",r),h.texture):null}}}return a}function s(a){let c=0;const l=6;for(let u=0;u<l;u++)a[u]!==void 0&&c++;return c===l}function r(a){const c=a.target;c.removeEventListener("dispose",r);const l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function jM(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const s=e(n);return s===null&&fr("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function $M(i,t,e,n){const s={},r=new WeakMap;function o(h){const d=h.target;d.index!==null&&t.remove(d.index);for(const _ in d.attributes)t.remove(d.attributes[_]);for(const _ in d.morphAttributes){const g=d.morphAttributes[_];for(let p=0,f=g.length;p<f;p++)t.remove(g[p])}d.removeEventListener("dispose",o),delete s[d.id];const m=r.get(d);m&&(t.remove(m),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function a(h,d){return s[d.id]===!0||(d.addEventListener("dispose",o),s[d.id]=!0,e.memory.geometries++),d}function c(h){const d=h.attributes;for(const _ in d)t.update(d[_],i.ARRAY_BUFFER);const m=h.morphAttributes;for(const _ in m){const g=m[_];for(let p=0,f=g.length;p<f;p++)t.update(g[p],i.ARRAY_BUFFER)}}function l(h){const d=[],m=h.index,_=h.attributes.position;let g=0;if(m!==null){const y=m.array;g=m.version;for(let x=0,T=y.length;x<T;x+=3){const w=y[x+0],E=y[x+1],b=y[x+2];d.push(w,E,E,b,b,w)}}else if(_!==void 0){const y=_.array;g=_.version;for(let x=0,T=y.length/3-1;x<T;x+=3){const w=x+0,E=x+1,b=x+2;d.push(w,E,E,b,b,w)}}else return;const p=new(af(d)?mf:pf)(d,1);p.version=g;const f=r.get(h);f&&t.remove(f),r.set(h,p)}function u(h){const d=r.get(h);if(d){const m=h.index;m!==null&&d.version<m.version&&l(h)}else l(h);return r.get(h)}return{get:a,update:c,getWireframeAttribute:u}}function ZM(i,t,e){let n;function s(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function c(d,m){i.drawElements(n,m,r,d*o),e.update(m,n,1)}function l(d,m,_){_!==0&&(i.drawElementsInstanced(n,m,r,d*o,_),e.update(m,n,_))}function u(d,m,_){if(_===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,r,d,0,_);let p=0;for(let f=0;f<_;f++)p+=m[f];e.update(p,n,1)}function h(d,m,_,g){if(_===0)return;const p=t.get("WEBGL_multi_draw");if(p===null)for(let f=0;f<d.length;f++)l(d[f]/o,m[f],g[f]);else{p.multiDrawElementsInstancedWEBGL(n,m,0,r,d,0,g,0,_);let f=0;for(let y=0;y<_;y++)f+=m[y];for(let y=0;y<g.length;y++)e.update(f,n,g[y])}}this.setMode=s,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function KM(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(e.calls++,o){case i.TRIANGLES:e.triangles+=a*(r/3);break;case i.LINES:e.lines+=a*(r/2);break;case i.LINE_STRIP:e.lines+=a*(r-1);break;case i.LINE_LOOP:e.lines+=a*r;break;case i.POINTS:e.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function JM(i,t,e){const n=new WeakMap,s=new Ae;function r(o,a,c){const l=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let d=n.get(a);if(d===void 0||d.count!==h){let v=function(){C.dispose(),n.delete(a),a.removeEventListener("dispose",v)};var m=v;d!==void 0&&d.texture.dispose();const _=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,p=a.morphAttributes.color!==void 0,f=a.morphAttributes.position||[],y=a.morphAttributes.normal||[],x=a.morphAttributes.color||[];let T=0;_===!0&&(T=1),g===!0&&(T=2),p===!0&&(T=3);let w=a.attributes.position.count*T,E=1;w>t.maxTextureSize&&(E=Math.ceil(w/t.maxTextureSize),w=t.maxTextureSize);const b=new Float32Array(w*E*4*h),C=new lf(b,w,E,h);C.type=Zn,C.needsUpdate=!0;const S=T*4;for(let R=0;R<h;R++){const P=f[R],N=y[R],F=x[R],z=w*E*4*R;for(let U=0;U<P.count;U++){const B=U*S;_===!0&&(s.fromBufferAttribute(P,U),b[z+B+0]=s.x,b[z+B+1]=s.y,b[z+B+2]=s.z,b[z+B+3]=0),g===!0&&(s.fromBufferAttribute(N,U),b[z+B+4]=s.x,b[z+B+5]=s.y,b[z+B+6]=s.z,b[z+B+7]=0),p===!0&&(s.fromBufferAttribute(F,U),b[z+B+8]=s.x,b[z+B+9]=s.y,b[z+B+10]=s.z,b[z+B+11]=F.itemSize===4?s.w:1)}}d={count:h,texture:C,size:new Gt(w,E)},n.set(a,d),a.addEventListener("dispose",v)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",o.morphTexture,e);else{let _=0;for(let p=0;p<l.length;p++)_+=l[p];const g=a.morphTargetsRelative?1:1-_;c.getUniforms().setValue(i,"morphTargetBaseInfluence",g),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",d.texture,e),c.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function QM(i,t,e,n){let s=new WeakMap;function r(c){const l=n.render.frame,u=c.geometry,h=t.get(c,u);if(s.get(h)!==l&&(t.update(h),s.set(h,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),s.get(c)!==l&&(e.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){const d=c.skeleton;s.get(d)!==l&&(d.update(),s.set(d,l))}return h}function o(){s=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:r,dispose:o}}class Sf extends Xe{constructor(t,e,n,s,r,o,a,c,l,u=Ps){if(u!==Ps&&u!==Ys)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===Ps&&(n=es),n===void 0&&u===Ys&&(n=Xs),super(null,s,r,o,a,c,u,n,l),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=a!==void 0?a:rn,this.minFilter=c!==void 0?c:rn,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const Mf=new Xe,mh=new Sf(1,1),Tf=new lf,Ef=new kx,bf=new vf,_h=[],gh=[],vh=new Float32Array(16),xh=new Float32Array(9),yh=new Float32Array(4);function nr(i,t,e){const n=i[0];if(n<=0||n>0)return i;const s=t*e;let r=_h[s];if(r===void 0&&(r=new Float32Array(s),_h[s]=r),t!==0){n.toArray(r,0);for(let o=1,a=0;o!==t;++o)a+=e,i[o].toArray(r,a)}return r}function Ee(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function be(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function Ba(i,t){let e=gh[t];e===void 0&&(e=new Int32Array(t),gh[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function tT(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function eT(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ee(e,t))return;i.uniform2fv(this.addr,t),be(e,t)}}function nT(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(Ee(e,t))return;i.uniform3fv(this.addr,t),be(e,t)}}function iT(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ee(e,t))return;i.uniform4fv(this.addr,t),be(e,t)}}function sT(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ee(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),be(e,t)}else{if(Ee(e,n))return;yh.set(n),i.uniformMatrix2fv(this.addr,!1,yh),be(e,n)}}function rT(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ee(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),be(e,t)}else{if(Ee(e,n))return;xh.set(n),i.uniformMatrix3fv(this.addr,!1,xh),be(e,n)}}function oT(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ee(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),be(e,t)}else{if(Ee(e,n))return;vh.set(n),i.uniformMatrix4fv(this.addr,!1,vh),be(e,n)}}function aT(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function cT(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ee(e,t))return;i.uniform2iv(this.addr,t),be(e,t)}}function lT(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ee(e,t))return;i.uniform3iv(this.addr,t),be(e,t)}}function uT(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ee(e,t))return;i.uniform4iv(this.addr,t),be(e,t)}}function hT(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function dT(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ee(e,t))return;i.uniform2uiv(this.addr,t),be(e,t)}}function fT(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ee(e,t))return;i.uniform3uiv(this.addr,t),be(e,t)}}function pT(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ee(e,t))return;i.uniform4uiv(this.addr,t),be(e,t)}}function mT(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(mh.compareFunction=of,r=mh):r=Mf,e.setTexture2D(t||r,s)}function _T(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture3D(t||Ef,s)}function gT(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTextureCube(t||bf,s)}function vT(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture2DArray(t||Tf,s)}function xT(i){switch(i){case 5126:return tT;case 35664:return eT;case 35665:return nT;case 35666:return iT;case 35674:return sT;case 35675:return rT;case 35676:return oT;case 5124:case 35670:return aT;case 35667:case 35671:return cT;case 35668:case 35672:return lT;case 35669:case 35673:return uT;case 5125:return hT;case 36294:return dT;case 36295:return fT;case 36296:return pT;case 35678:case 36198:case 36298:case 36306:case 35682:return mT;case 35679:case 36299:case 36307:return _T;case 35680:case 36300:case 36308:case 36293:return gT;case 36289:case 36303:case 36311:case 36292:return vT}}function yT(i,t){i.uniform1fv(this.addr,t)}function ST(i,t){const e=nr(t,this.size,2);i.uniform2fv(this.addr,e)}function MT(i,t){const e=nr(t,this.size,3);i.uniform3fv(this.addr,e)}function TT(i,t){const e=nr(t,this.size,4);i.uniform4fv(this.addr,e)}function ET(i,t){const e=nr(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function bT(i,t){const e=nr(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function wT(i,t){const e=nr(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function AT(i,t){i.uniform1iv(this.addr,t)}function CT(i,t){i.uniform2iv(this.addr,t)}function RT(i,t){i.uniform3iv(this.addr,t)}function DT(i,t){i.uniform4iv(this.addr,t)}function PT(i,t){i.uniform1uiv(this.addr,t)}function IT(i,t){i.uniform2uiv(this.addr,t)}function NT(i,t){i.uniform3uiv(this.addr,t)}function LT(i,t){i.uniform4uiv(this.addr,t)}function OT(i,t,e){const n=this.cache,s=t.length,r=Ba(e,s);Ee(n,r)||(i.uniform1iv(this.addr,r),be(n,r));for(let o=0;o!==s;++o)e.setTexture2D(t[o]||Mf,r[o])}function UT(i,t,e){const n=this.cache,s=t.length,r=Ba(e,s);Ee(n,r)||(i.uniform1iv(this.addr,r),be(n,r));for(let o=0;o!==s;++o)e.setTexture3D(t[o]||Ef,r[o])}function FT(i,t,e){const n=this.cache,s=t.length,r=Ba(e,s);Ee(n,r)||(i.uniform1iv(this.addr,r),be(n,r));for(let o=0;o!==s;++o)e.setTextureCube(t[o]||bf,r[o])}function kT(i,t,e){const n=this.cache,s=t.length,r=Ba(e,s);Ee(n,r)||(i.uniform1iv(this.addr,r),be(n,r));for(let o=0;o!==s;++o)e.setTexture2DArray(t[o]||Tf,r[o])}function BT(i){switch(i){case 5126:return yT;case 35664:return ST;case 35665:return MT;case 35666:return TT;case 35674:return ET;case 35675:return bT;case 35676:return wT;case 5124:case 35670:return AT;case 35667:case 35671:return CT;case 35668:case 35672:return RT;case 35669:case 35673:return DT;case 5125:return PT;case 36294:return IT;case 36295:return NT;case 36296:return LT;case 35678:case 36198:case 36298:case 36306:case 35682:return OT;case 35679:case 36299:case 36307:return UT;case 35680:case 36300:case 36308:case 36293:return FT;case 36289:case 36303:case 36311:case 36292:return kT}}class VT{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=xT(e.type)}}class zT{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=BT(e.type)}}class GT{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(t,e[a.id],n)}}}const Sc=/(\w+)(\])?(\[|\.)?/g;function Sh(i,t){i.seq.push(t),i.map[t.id]=t}function HT(i,t,e){const n=i.name,s=n.length;for(Sc.lastIndex=0;;){const r=Sc.exec(n),o=Sc.lastIndex;let a=r[1];const c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===s){Sh(e,l===void 0?new VT(a,i,t):new zT(a,i,t));break}else{let h=e.map[a];h===void 0&&(h=new GT(a),Sh(e,h)),e=h}}}class Po{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=t.getActiveUniform(e,s),o=t.getUniformLocation(e,r.name);HT(r,o,this)}}setValue(t,e,n,s){const r=this.map[e];r!==void 0&&r.setValue(t,n,s)}setOptional(t,e,n){const s=e[n];s!==void 0&&this.setValue(t,n,s)}static upload(t,e,n,s){for(let r=0,o=e.length;r!==o;++r){const a=e[r],c=n[a.id];c.needsUpdate!==!1&&a.setValue(t,c.value,s)}}static seqWithValue(t,e){const n=[];for(let s=0,r=t.length;s!==r;++s){const o=t[s];o.id in e&&n.push(o)}return n}}function Mh(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const WT=37297;let qT=0;function XT(i,t){const e=i.split(`
`),n=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let o=s;o<r;o++){const a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}function YT(i){const t=ee.getPrimaries(ee.workingColorSpace),e=ee.getPrimaries(i);let n;switch(t===e?n="":t===_a&&e===ma?n="LinearDisplayP3ToLinearSRGB":t===ma&&e===_a&&(n="LinearSRGBToLinearDisplayP3"),i){case bi:case Ua:return[n,"LinearTransferOETF"];case Cn:case Yl:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function Th(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),s=i.getShaderInfoLog(t).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const o=parseInt(r[1]);return e.toUpperCase()+`

`+s+`

`+XT(i.getShaderSource(t),o)}else return s}function jT(i,t){const e=YT(t);return`vec4 ${i}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function $T(i,t){let e;switch(t){case dx:e="Linear";break;case fx:e="Reinhard";break;case px:e="Cineon";break;case mx:e="ACESFilmic";break;case gx:e="AgX";break;case vx:e="Neutral";break;case _x:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const So=new G;function ZT(){ee.getLuminanceCoefficients(So);const i=So.x.toFixed(4),t=So.y.toFixed(4),e=So.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function KT(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(ur).join(`
`)}function JT(i){const t=[];for(const e in i){const n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function QT(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:i.getAttribLocation(t,o),locationSize:a}}return e}function ur(i){return i!==""}function Eh(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function bh(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const tE=/^[ \t]*#include +<([\w\d./]+)>/gm;function hl(i){return i.replace(tE,nE)}const eE=new Map;function nE(i,t){let e=kt[t];if(e===void 0){const n=eE.get(t);if(n!==void 0)e=kt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return hl(e)}const iE=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function wh(i){return i.replace(iE,sE)}function sE(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Ah(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function rE(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===qd?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===k0?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Yn&&(t="SHADOWMAP_TYPE_VSM"),t}function oE(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Ws:case qs:t="ENVMAP_TYPE_CUBE";break;case Oa:t="ENVMAP_TYPE_CUBE_UV";break}return t}function aE(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case qs:t="ENVMAP_MODE_REFRACTION";break}return t}function cE(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Xd:t="ENVMAP_BLENDING_MULTIPLY";break;case ux:t="ENVMAP_BLENDING_MIX";break;case hx:t="ENVMAP_BLENDING_ADD";break}return t}function lE(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function uE(i,t,e,n){const s=i.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=rE(e),l=oE(e),u=aE(e),h=cE(e),d=lE(e),m=KT(e),_=JT(r),g=s.createProgram();let p,f,y=e.glslVersion?"#version "+e.glslVersion+`
