...
`;const n=i.querySelector(".grid");if(!n)throw new Error("ゲーム一覧セクションが見つかりません");a.forEach(s=>{const r=document.createElement("article");r.className="card",r.innerHTML=`
