...
`;const n=i.querySelector(".grid");if(!n)throw new Error("ゲーム一覧セクションが見つかりません");c.forEach(r=>{const s=document.createElement("article");s.className="card",s.innerHTML=`
